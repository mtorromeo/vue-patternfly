...
<pf-text-input
  ...
  auto-validate="input"
  no-status-icon />`},{default:n(()=>[e(t,{required:"",pattern:"[0-9a-f]*",placeholder:"hexadecimal value (does not validate)","aria-label":"does not validate","auto-validate":!1}),a[5]||(a[5]=o("br",null,null,-1)),e(t,{required:"",pattern:"[0-9a-f]*",placeholder:"hexadecimal value (validates on enter/submit)","aria-label":"validates on enter/submit","auto-validate":""}),a[6]||(a[6]=o("br",null,null,-1)),e(t,{required:"",pattern:"[0-9a-f]*",placeholder:"hexadecimal value (validates on blur)","aria-label":"validates on blur","auto-validate":"blur"}),a[7]||(a[7]=o("br",null,null,-1)),e(t,{modelValue:s.value,"onUpdate:modelValue":a[2]||(a[2]=i=>s.value=i),required:"",pattern:"[0-9a-f]*",placeholder:"hexadecimal value (validates on change)","aria-label":"validates on change","auto-validate":"change"},null,8,["modelValue"]),a[8]||(a[8]=o("br",null,null,-1)),e(t,{required:"",pattern:"[0-9a-f]*",placeholder:"hexadecimal value (validates on input)","aria-label":"validates on input","auto-validate":"input"}),a[9]||(a[9]=o("br",null,null,-1)),e(t,{required:"",pattern:"[0-9a-f]*",placeholder:"hexadecimal value (no status icon)","aria-label":"no status icon","auto-validate":"input","no-status-icon":""})]),_:1,__:[5,6,7,8,9]}),e(l,{title:"Truncated on left",source:'<pf-text-input start-truncated model-value="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat." />'},{default:n(()=>[e(t,{"start-truncated":"","model-value":"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."})]),_:1}),e(l,{title:"Select all",source:`<pf-text-input
model-value="select all on click"
aria-label="select-all"
@focus="($event.currentTarget as HTMLInputElement).select()" />`},{default:n(()=>[e(t,{"model-value":"select all on click","aria-label":"select-all",onFocus:a[3]||(a[3]=i=>i.currentTarget.select())})]),_:1}),e(l,{title:"Custom icon",source:`<pf-text-input aria-label="text input example">
  <template #icon>
    <ClockIcon />
  </template>
</pf-text-input>`},{default:n(()=>[e(t,{"aria-label":"text input example"},{icon:n(()=>[e(h(g))]),_:1})]),_:1})]),_:1})}}});export{k as default};
