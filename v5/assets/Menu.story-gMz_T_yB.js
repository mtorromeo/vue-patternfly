...
</pf-menu>`},{default:n(()=>[e(l,null,{default:n(()=>[(b(!0),x(L,null,F(D,(A,h)=>(b(),M(g,{key:h,label:h},{default:n(()=>[(b(!0),x(L,null,F(A,c=>(b(),M(a,{key:c.value,favorited:c.favorite,"onUpdate:favorited":T=>c.favorite=T,name:c.value,value:c.value,description:c.description,disabled:c.disabled},null,8,["favorited","onUpdate:favorited","name","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(u,{title:"Filtering with search input",source:`<pf-menu>
  <pf-menu-input>
