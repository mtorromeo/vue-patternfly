...
export const ToolbarLabelGroupContentRefKey = Symbol('ToolbarLabelGroupContentRefKey') as InjectionKey<Ref<HTMLDivElement | undefined>>;
...
const labelGroupContent: Ref<HTMLDivElement | undefined> = ref();
...
onBeforeUnmount(() => {
  if (labelGroupContent.value) {
    labelGroupContent.value = undefined;
  }
});
