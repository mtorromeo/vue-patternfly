      ...
      >
        ...
        <floating-ui :teleport-to="tabMoreRef" :reference="overflowTabRef">
          <pf-menu v-if="managedExpanded" v-bind="$attrs">
            <pf-menu-content>
              <pf-menu-list ref="tabOverflowRef" />
            </pf-menu-content>
          </pf-menu>
        </floating-ui>
      </li>
...
import { watch, watchEffect, nextTick, onMounted, provide, computed, type Ref, ref, type HTMLAttributes } from 'vue';
...
const tabMoreRef: Ref<HTMLElement | undefined> = ref();
