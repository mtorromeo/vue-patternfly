...
<Canvas>
  <Story name="OutsideFailure" args={{
    value: 33,
    title: 'Title',
    variant: 'danger',
    measureLocation: 'outside',
...
<Canvas>
  <Story name="WithoutMeasure" args={{
    value: 33,
    title: 'Title',
...
<Canvas>
  <Story name="FailureWithoutMeasure" args={{
    value: 33,
    title: 'Title',
    variant: 'danger',
    measureLocation: 'none',
...
<Canvas>
  <Story name="StepInstruction" args={{
    title: 'Title',
    value: 2,
    max: 5,
