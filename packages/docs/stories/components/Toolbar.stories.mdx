...
import {
  ...
  PfToolbarGroup,
  PfToolbarItem,
} from '@core/components/Toolbar/index.js';
import PfInputGroup from '@core/components/InputGroup/InputGroup.vue';
...
<Canvas withSource="open">
  <Story name="Adjusting toolbar inset" args={{
    inset: 'none',
    'inset-md': 'sm',
    'inset-xl': '2xl',
    'inset-2xl': 'lg',
...
<Canvas withSource="open">
  <Story name="Adjusting item spacers" args={{
    inset: 'none',
    'inset-md': 'sm',
    'inset-xl': '2xl',
    'inset-2xl': 'lg',
