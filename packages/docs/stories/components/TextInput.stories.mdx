...
<Meta title="Components/Text Input" component={PfTextInput} argTypes={{
    iconVariant: {
      control: {
        type: 'select',
      },
...
<Canvas withSource="open">
  <Story name="Default" args={{
    pattern: '[0-9A-Fa-f]',
    placeholder: 'hexadecimal format only',
  }}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas withSource="open">
  <Story name="Truncated on left" args={{
    leftTruncated: true,
    value:
