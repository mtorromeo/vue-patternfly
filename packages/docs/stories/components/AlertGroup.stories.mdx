...
import { ref } from 'vue';
import { PfAlert, PfAlertGroup } from '@vue-patternfly/core';
...
<Meta title="Components/Alert Group" component={PfAlertGroup} subcomponents={{PfAlert}} />

# PfAlertGroup `pf-alert-group`
