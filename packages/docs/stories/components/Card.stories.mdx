...
- The expanded state si controlled by `v-model:expanded` or managed internally with the prop `expandable`.
...
<Canvas>
  <Story name="WithImageAndActions">
...
<Canvas>
  <Story name="ExpandableWithIcon" args={{expandable: true}}>
