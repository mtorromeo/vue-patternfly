import{C as i}from"./circle-info-icon-BuM9yFqm.js";import{g as w,m as c,a as b,c as v,o as g,w as e,b as o,d as f,e as n,u as a}from"./index-DJ3MOq50.js";const y=w({__name:"Label.story",setup(C){const d=c();function r(u){const l=u.target?.closest(".pf-v6-c-label");l instanceof HTMLElement&&d.add({title:`Clicked close button on "${l.innerText}"`,variant:"info"})}return(u,l)=>{const m=b("component-info"),t=b("pf-label"),p=b("story-canvas"),s=b("doc-page");return g(),v(s,{name:"Components/Label.story.vue",title:"Label"},{description:e(()=>[...l[0]||(l[0]=[n("The ",-1),f("b",null,"label",-1),n(" component allows users to add specific element captions for user clarity and convenience.",-1)])]),apidocs:e(()=>[o(m,{src:"packages/core/src/components/Label.vue"})]),default:e(()=>[o(p,{title:"Filled",source:`<pf-label>Grey</pf-label>
<pf-label>
  <template #icon>
    <circle-info-icon />
  </template>Grey icon
