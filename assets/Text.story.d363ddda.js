import{e as _,r as x,a as p,c as m,w as t,o as d,b as e,g as o,t as r,d as c}from"./index.85902118.js";const u=c("div",{class:"markdown pf-c-content"},[c("h2",{class:"pf-c-title"},"Examples")],-1),h=c("br",null,null,-1),g=_({__name:"Text.story",setup(k){const l=x("Title text");return(V,v)=>{const s=p("component-title"),n=p("pf-text"),a=p("story-canvas"),f=p("pf-text-content"),i=p("doc-page");return d(),m(i,{title:"Text"},{default:t(()=>[e(s,{name:"pf-text"}),u,e(a,{title:"Text",source:"<pf-text>{{ sample_title }}</pf-text>"},{default:t(()=>[e(n,null,{default:t(()=>[o(r(l.value),1)]),_:1})]),_:1}),e(a,{title:"Text visited",source:`<pf-text-content>
