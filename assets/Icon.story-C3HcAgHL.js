...
</pf-icon>`},{default:e(()=>[a("div",R,[n(I,{modelValue:f.value,"onUpdate:modelValue":o[1]||(o[1]=d=>f.value=d),label:"Toggle in progress state","aria-label":"Set icon progress state"},null,8,["modelValue"])]),n(i,{"in-progress":f.value},{"progress-icon":e(()=>[n(C,{diameter:"2em","aria-label":"Loading..."})]),default:e(()=>[n(t(g))]),_:1},8,["in-progress"])]),_:1})]),_:1})}}});export{W as default};
