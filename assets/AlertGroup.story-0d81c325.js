import{e as b,f as y,l as $,a as o,o as u,c as A,w as t,b as e,g as i,h as _,i as T,F as m}from"./index-92e11c35.js";const I=4,h=b({__name:"AlertGroup.story",setup(q){const c=y([]),r=()=>new Date().getTime(),l=y([]),w=()=>console.log("Overflow message clicked"),C=$(()=>{const f=l.length-I;return f>0?`View ${f} more alerts`:""});return(f,n)=>{const D=o("component-title"),p=o("pf-alert"),d=o("pf-alert-group"),v=o("story-canvas"),s=o("pf-button"),k=o("pf-input-group"),S=o("doc-page");return u(),A(S,{title:"Alert Group"},{default:t(()=>[e(D,{name:"pf-alert-group"}),e(v,{title:"Static",source:`<pf-alert-group>
