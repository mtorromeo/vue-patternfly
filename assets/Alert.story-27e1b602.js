import{U as W,B,D as U,S as q,L as N}from"./laptop-icon-62b01014.js";import{e as z,r as h,f as D,a as c,o as s,c as b,w as e,b as t,g as l,d as _,t as F,h as f,i as x,F as d,j as Y,u as v,p as j,k as E,_ as G}from"./index-3a5bf38d.js";import"./createIcon-b1f9a1a3.js";const I=m=>(j("data-v-4c2bb481"),m=m(),E(),m),H=I(()=>_("p",null,"Success alert description. This should tell the user more information about the alert.",-1)),J=I(()=>_("code",null,"live-region",-1)),K=I(()=>_("code",null,"live-region",-1)),M=z({__name:"Alert.story",setup(m){const R=h("Alert text"),g=D([]),o=w=>window.alert(w),k=()=>new Date().getTime(),A=D([]);let C;const T=()=>{clearInterval(C)},$=()=>{C=setInterval(()=>{A.push({title:`This is a async alert number ${A.length+1}`,variant:"info",liveRegion:!0,key:k()})},1500)},p=h(!1);return(w,a)=>{const V=c("component-title"),n=c("pf-alert"),r=c("story-canvas"),y=c("pf-alert-action-link"),u=c("pf-button"),S=c("pf-input-group"),L=c("doc-page");return s(),b(L,{title:"Alert"},{default:e(()=>[t(V,{name:"pf-alert"}),t(r,{title:"Types",source:`<pf-alert title="Default alert title" ></pf-alert>
...
<pf-alert
  ...
  :aria-atomic="a.ariaAtomic" />`},{default:e(()=>[t(S,{style:{"margin-bottom":"16px"}},{default:e(()=>[t(u,{variant:"secondary",onClick:a[8]||(a[8]=i=>g.push({title:"Single Success Alert",variant:"success",liveRegion:!0,key:k()}))},{default:e(()=>[l(" Add Single Success Alert ")]),_:1}),t(u,{variant:"secondary",onClick:a[9]||(a[9]=i=>g.push({title:"Single Info Alert",variant:"info",liveRegion:!0,key:k()}))},{default:e(()=>[l(" Add Single Info Alert ")]),_:1}),t(u,{variant:"secondary",onClick:a[10]||(a[10]=i=>g.push({title:"Single Danger Alert",variant:"danger",ariaLive:"assertive",ariaRelevant:"additions text",ariaAtomic:"false",key:k()}))},{default:e(()=>[l(" Add Single Danger Alert ")]),_:1})]),_:1}),(s(!0),f(d,null,x(g,i=>(s(),b(n,{key:i.key,variant:i.variant,title:i.title,"live-region":i.liveRegion,"aria-live":i.ariaLive,"aria-relevant":i.ariaRelevant,"aria-atomic":i.ariaAtomic},null,8,["variant","title","live-region","aria-live","aria-relevant","aria-atomic"]))),128))]),_:1}),t(r,{title:"Async live region",source:`<pf-input-group style="margin-bottom: 16px">
...
<pf-alert
  ...
  :variant="a.variant"
  :title="a.title"
  :live-region="a.liveRegion" />`},{default:e(()=>[t(S,{style:{"margin-bottom":"16px"}},{default:e(()=>[t(u,{variant:"secondary",onClick:$},{default:e(()=>[l("Start Async Info Alerts")]),_:1}),t(u,{variant:"secondary",onClick:T},{default:e(()=>[l("Stop Async Info Alerts")]),_:1})]),_:1}),(s(!0),f(d,null,x(A,i=>(s(),b(n,{key:i.key,variant:i.variant,title:i.title,"live-region":i.liveRegion},null,8,["variant","title","live-region"]))),128))]),_:1}),t(r,{title:"Alert timeout",source:`<pf-input-group style="margin-bottom: 16px">
  <pf-button
    variant="secondary"
...
</pf-input-group>`},{default:e(()=>[t(S,{style:{"margin-bottom":"16px"}},{default:e(()=>[t(u,{variant:"secondary",disabled:p.value,onClick:a[11]||(a[11]=i=>p.value=!p.value)},{default:e(()=>[p.value?(s(),f(d,{key:0},[l("0 alerts to show")],64)):(s(),f(d,{key:1},[l("Show 2 alerts")],64))]),_:1},8,["disabled"])]),_:1}),p.value?(s(),f(d,{key:0},[t(n,{title:"Default timeout Alert",timeout:""},{default:e(()=>[l(" This alert will dismiss after 8 seconds ")]),_:1}),t(n,{title:"Custom timeout Alert",timeout:16e3},{default:e(()=>[l(" This alert will dismiss after 16 seconds ")]),_:1})],64)):Y("",!0)]),_:1}),t(r,{title:"Custom icons",source:`<pf-alert title="Default alert title">
