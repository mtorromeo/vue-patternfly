import{e as C,r as x,f as P,a as n,o as p,c as f,w as l,b as e,g as o,j as h,h as k,i as b,F as _,d as s}from"./index-02fd22a6.js";const w=s("div",{class:"markdown pf-c-content"},[s("p",null,[o("A "),s("strong",null,"select list"),o(" enables users to select one or more items from a list. Use a select list when options are dynamic or variable. "),s("a",{href:"https://www.patternfly.org/v4/components/select/design-guidelines"},"View PatternFly design guidelines")]),s("h2",{class:"pf-c-title"},"Differences from patternfly-react"),s("ul",null,[s("li",null,[o("There is no "),s("code",null,"grouped"),o(" prop since the presence of groups is auto-detected. See "),s("a",{href:"#/"},"common differences from patternfly-react"),o(".")])]),s("h2",{class:"pf-c-title"},"Examples")],-1),T=C({__name:"Select.story",setup(F){const u=x(!1),M=P({Status:[{value:"Running",favorite:!1,description:"This is a description."},{value:"Stopped",favorite:!1},{value:"Down",favorite:!1,disabled:!0},{value:"Degraded",favorite:!1},{value:"Needs maintenance",favorite:!1}],"Vendor names":[{value:"Dell",favorite:!1},{value:"Samsung",favorite:!1},{value:"Hewlett-Packard",favorite:!1,description:"This is a description."}]});return(S,V)=>{const g=n("component-title"),t=n("pf-select-option"),c=n("pf-select"),a=n("story-canvas"),d=n("pf-divider"),r=n("pf-select-group"),m=n("doc-page");return p(),f(m,{title:"Select"},{default:l(()=>[e(g,{name:"pf-select"}),w,e(a,{title:"Single",source:`<pf-select>
...
</pf-select>`},{default:l(()=>[e(c,null,{default:l(()=>[e(t,{placeholder:"",disabled:""},{default:l(()=>[o(" Please Choose ")]),_:1}),e(t,{value:"Mr"}),e(t,{value:"Miss"}),e(t,{value:"Mrs"}),e(t,{value:"Ms"}),e(t,{value:"Dr",disabled:""})]),_:1})]),_:1}),e(a,{title:"Single with description",source:`<pf-select>
...
</pf-select>`},{default:l(()=>[e(c,null,{default:l(()=>[e(t,{value:"Active",description:"This is a description"}),e(t,{value:"Cancelled"}),e(t,{value:"Paused"}),u.value?(p(),f(d,{key:0})):h("",!0),e(t,{value:"Warning"}),e(t,{value:"Restarted"})]),_:1})]),_:1}),e(a,{title:"Grouped single",source:`<pf-select>
...
</pf-select>`},{default:l(()=>[e(c,{placeholder:"Filter by status",variant:"checkbox"},{default:l(()=>[e(t,{placeholder:"",disabled:""},{default:l(()=>[o(" Please Choose ")]),_:1}),e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1})]),_:1}),e(a,{title:"Checkbox input with counts",source:`<pf-select placeholder="Filter by status" variant="checkbox">
  <pf-select-option placeholder disabled>
    Please Choose
  </pf-select-option>
  <pf-select-option check value="Mr" ></pf-select-option>
  ...
  <pf-select-option check value="Ms" ></pf-select-option>
  <pf-select-option check value="Dr" disabled ></pf-select-option>
</pf-select>`},{default:l(()=>[e(c,{placeholder:"Filter by status",variant:"checkbox"},{default:l(()=>[e(t,{placeholder:"",disabled:""},{default:l(()=>[o(" Please Choose ")]),_:1}),e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1})]),_:1}),e(a,{title:"Checkbox input no badge",source:`<pf-select placeholder="Filter by status" variant="checkbox" selection-badge-hidden>
  <pf-select-option placeholder disabled>
    Please Choose
  </pf-select-option>
  <pf-select-option check value="Mr" ></pf-select-option>
  ...
  <pf-select-option check value="Ms" ></pf-select-option>
  <pf-select-option check value="Dr" disabled ></pf-select-option>
</pf-select>`},{default:l(()=>[e(c,{placeholder:"Filter by status",variant:"checkbox","selection-badge-hidden":""},{default:l(()=>[e(t,{placeholder:"",disabled:""},{default:l(()=>[o(" Please Choose ")]),_:1}),e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1})]),_:1}),e(a,{title:"Grouped checkbox input",source:`<pf-select placeholder="Filter by status" variant="checkbox">
  <pf-select-option placeholder disabled>
    Please Choose
  </pf-select-option>
  <pf-select-option check value="Mr" ></pf-select-option>
  ...
  <pf-select-option check value="Ms" ></pf-select-option>
  <pf-select-option check value="Dr" disabled ></pf-select-option>
</pf-select>`},{default:l(()=>[e(c,{placeholder:"Filter by status",variant:"checkbox"},{default:l(()=>[e(t,{placeholder:"",disabled:""},{default:l(()=>[o(" Please Choose ")]),_:1}),e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1})]),_:1}),e(a,{title:"Grouped single with filtering",source:`<pf-select placeholder="Filter by status" variant="checkbox" inline-filter>
  <pf-select-option placeholder disabled>
    Please Choose
  </pf-select-option>
  <pf-select-option check value="Mr" ></pf-select-option>
  ...
  <pf-select-option check value="Ms" ></pf-select-option>
  <pf-select-option check value="Dr" disabled ></pf-select-option>
</pf-select>`},{default:l(()=>[e(c,{placeholder:"Filter by status",variant:"checkbox","inline-filter":""},{default:l(()=>[e(t,{placeholder:"",disabled:""},{default:l(()=>[o(" Please Choose ")]),_:1}),e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1})]),_:1}),e(a,{title:"Favorites",source:`<pf-select>
