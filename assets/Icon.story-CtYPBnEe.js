...
<pf-icon>
  <GearIcon />
</pf-icon>`},{default:e(()=>[s(E,null,{default:e(()=>[s(a(_))]),_:1}),s(E,null,{default:e(()=>[s(a(v))]),_:1}),s(E,null,{default:e(()=>[s(a(u))]),_:1}),s(E,null,{default:e(()=>[s(a(d))]),_:1})]),_:1}),s(D,{title:`Size`,source:`<pf-icon size="sm">
  <CirclePlusIcon />
</pf-icon>
<pf-icon size="md">
  <CirclePlusIcon />
...
<pf-icon status="custom">
  <BellIcon />
</pf-icon>`},{intro:e(()=>[...i[3]||=[l(`div`,{class:`markdown pf-v6-c-content`},[l(`p`,null,`The following example demonstrates the various status variants of an icon. Keep in mind that these icons are displayed out of a typical context, and that you should not rely on color alone to convey status to users.`)],-1)]]),default:e(()=>[s(E,{status:`danger`},{default:e(()=>[s(a(m))]),_:1}),s(E,{status:`warning`},{default:e(()=>[s(a(h))]),_:1}),s(E,{status:`success`},{default:e(()=>[s(a(p))]),_:1}),s(E,{status:`info`},{default:e(()=>[s(a(g))]),_:1}),s(E,{status:`custom`},{default:e(()=>[s(a(f))]),_:1})]),_:1}),s(D,{title:`Sizing an icon within the icon container`,source:`<pf-icon size="xl" icon-size="sm">
  <CirclePlusIcon />
</pf-icon>
