import{e as b,f as _,m as $,a as o,o as c,c as A,w as t,b as e,g as i,h as m,i as T,F as I,u as q}from"./index.e4110fe9.js";const B=b({__name:"AlertGroup.story",setup(U){const u=_([]),r=()=>new Date().getTime(),l=_([]),w=()=>console.log("Overflow message clicked"),k=4,C=$(()=>{const f=l.length-k;return f>0?`View ${f} more alerts`:""});return(f,n)=>{const D=o("component-title"),p=o("pf-alert"),d=o("pf-alert-group"),v=o("story-canvas"),s=o("pf-button"),y=o("pf-input-group"),S=o("doc-page");return c(),A(S,{title:"Alert Group"},{default:t(()=>[e(D,{name:"pf-alert-group"}),e(v,{title:"Static",source:`<pf-alert-group>
