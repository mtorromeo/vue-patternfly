import{U as W,B,D as M,S as z,L as Y}from"./laptop-icon-5wus3LuG.js";import{f as j,r as R,g as C,h as H,a as p,o as s,c as b,w as t,b as l,d as e,e as I,t as J,i as d,j as T,F as f,k as K,u as h,p as Q,l as X,_ as Z}from"./index-9IxByHgl.js";const x=S=>(Q("data-v-8a6e9175"),S=S(),X(),S),ee=x(()=>I("b",null,"alert",-1)),te=x(()=>I("p",null,"Success alert description. This should tell the user more information about the alert.",-1)),ae=x(()=>I("code",null,"live-region",-1)),ne=x(()=>I("code",null,"live-region",-1)),L=4,ie=j({__name:"Alert.story",setup(S){const N=R("Alert text"),_=C([]),m=C([]),v=C([]),c=A=>window.alert(A),u=()=>new Date().getTime(),q=C([]);let $;const F=()=>{clearInterval($)},U=()=>{$=setInterval(()=>{q.push({title:`This is a async alert number ${q.length+1}`,variant:"info",liveRegion:!0,key:u()})},1500)},g=R(!1),G=()=>console.log("Overflow message clicked"),E=H(()=>{const A=m.length-L;return A>0?`View ${A} more alerts`:""});return(A,n)=>{const y=p("component-info"),i=p("pf-alert"),r=p("story-canvas"),w=p("pf-alert-action-link"),o=p("pf-button"),k=p("pf-input-group"),D=p("pf-alert-group"),P=p("doc-page");return s(),b(P,{title:"Alert"},{description:t(()=>[l("An "),ee,l(" is a notification that provides brief information to the user without blocking their workflow.")]),apidocs:t(()=>[e(y,{src:"packages/core/src/components/Alert/Alert.vue",doc:{name:"PfAlert",exportName:"default",displayName:"Alert",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"ariaLabel",description:"Adds accessible text to the alert.",required:!1,type:{name:"string"}},{name:"id",description:"Uniquely identifies the alert.",required:!1,type:{name:"string"}},{name:"expandable",description:"Flag indicating that the alert is expandable.",required:!1,type:{name:"boolean"}},{name:"expanded",description:"Flag indicating that the alert is expanded",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"undefined"}},{name:"onClose",description:"Show close button",required:!1,type:{name:"TSFunctionType"}},{name:"inline",description:"Flag to indicate if the alert is inline.",required:!1,type:{name:"boolean"}},{name:"liveRegion",description:"Flag to indicate if the alert is in a live region.",required:!1,type:{name:"boolean"}},{name:"plain",description:"Flag to indicate if the alert is plain.",required:!1,type:{name:"boolean"}},{name:"timeout",description:`If set to true, the timeout is 8000 milliseconds. If a number is provided, alert will
be dismissed after that amount of time in milliseconds.`,required:!1,type:{name:"union",elements:[{name:"number"},{name:"boolean"}]}},{name:"timeoutAnimation",description:"If the user hovers over the alert and `timeout` expires, this is how long to wait\nbefore finally dismissing the alert.",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"3000"}},{name:"title",description:"Title of the alert.",required:!1,type:{name:"string"}},{name:"component",description:"Sets the element to use as the alert title. Default is h4.",required:!1,type:{name:"union",elements:[{name:"string"},{name:"Component"}]},defaultValue:{func:!1,value:"'h4'"}},{name:"toggleAriaLabel",description:"Adds accessible text to the alert toggle.",required:!1,type:{name:"string"}},{name:"tooltipPosition",description:"Position of the tooltip which is displayed if text is truncated.",required:!1,type:{name:"TooltipPosition"},defaultValue:{func:!1,value:"'auto'"}},{name:"truncateTitle",description:"Truncate title to number of lines.",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"variant",description:"Adds alert variant styles.",required:!1,type:{name:"TSTypeOperator"},defaultValue:{func:!1,value:"'custom'"}},{name:"variantLabel",description:"Variant label text for screen readers.",required:!1,type:{name:"string"}}],events:[{name:"mouseenter",type:{names:["Event"]}},{name:"mouseleave",type:{names:["Event"]}},{name:"timeout"}],slots:[{name:"custom-icon"},{name:"default"},{name:"action-links"}],sourceFiles:["../../packages/core/src/components/Alert/Alert.vue"]}},null,8,["doc"]),e(y,{src:"packages/core/src/components/Alert/AlertActionLink.vue",doc:{name:"PfAlertActionLink",exportName:"default",displayName:"AlertActionLink",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Alert/AlertActionLink.vue"]}},null,8,["doc"]),e(y,{src:"packages/core/src/components/Alert/AlertGroup.vue",doc:{name:"PfAlertGroup",exportName:"default",displayName:"AlertGroup",description:"",tags:{},props:[{name:"toast",description:"Toast notifications are positioned at the top right corner of the viewport",required:!1,type:{name:"boolean"}},{name:"liveRegion",description:"Turns the container into a live region so that changes to content within the AlertGroup, such as appending an Alert, are reliably announced to assistive technology.",required:!1,type:{name:"boolean"}},{name:"appendTo",description:"Determine where the alert is appended to",required:!1,type:{name:"union",elements:[{name:"string"},{name:"RendererElement"},{name:"null"},{name:"undefined"}]},defaultValue:{func:!1,value:"'body'"}},{name:"overflowMessage",description:"Custom text to show for the overflow message",required:!1,type:{name:"string"}}],events:[{name:"overflow-click",type:{names:["union"],elements:[{name:"MouseEvent"},{name:"TouchEvent"}]}}],slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Alert/AlertGroup.vue"]}},null,8,["doc"]),e(y,{src:"packages/core/src/components/Alert/AlertGroupInline.vue",doc:{name:"PfAlertGroupInline",exportName:"default",displayName:"AlertGroupInline",description:"",tags:{},props:[{name:"toast",required:!1,type:{name:"boolean"}},{name:"liveRegion",required:!1,type:{name:"boolean"}},{name:"overflowMessage",required:!1,type:{name:"string"}}],events:[{name:"overflow-click",type:{names:["union"],elements:[{name:"MouseEvent"},{name:"TouchEvent"}]}}],slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Alert/AlertGroupInline.vue"]}},null,8,["doc"]),e(y,{src:"packages/core/src/components/Alert/AlertIcon.vue",doc:{name:"PfAlertIcon",exportName:"default",displayName:"AlertIcon",description:"",tags:{},props:[{name:"variant",required:!1,type:{name:"TSTypeOperator"},defaultValue:{func:!1,value:"'custom'"}}],slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Alert/AlertIcon.vue"]}},null,8,["doc"])]),default:t(()=>[e(r,{title:"Types",source:`<pf-alert title="Custom alert title" />
...
<pf-alert variant="danger" title="Danger alert title" />`},{default:t(()=>[e(i,{title:"Custom alert title"}),e(i,{variant:"info",title:"Info alert title"}),e(i,{variant:"success",title:"Success alert title"}),e(i,{variant:"warning",title:"Warning alert title"}),e(i,{variant:"danger",title:"Danger alert title"})]),_:1}),e(r,{title:"With action links",source:`<pf-alert title="Alert title" @close="alert('Clicked the close button')">
  ...
  <p>{{ sample_text }}</p>
</pf-alert>`},{default:t(()=>[e(i,{title:"Alert title",onClose:n[2]||(n[2]=a=>c("Clicked the close button"))},{"action-links":t(()=>[e(w,{onClick:n[0]||(n[0]=a=>c("Clicked on View details"))},{default:t(()=>[l("View details")]),_:1}),e(w,{onClick:n[1]||(n[1]=a=>c("Clicked on Ignore"))},{default:t(()=>[l("Ignore")]),_:1})]),default:t(()=>[I("p",null,J(N.value),1)]),_:1})]),_:1}),e(r,{title:"Inline types",source:`<pf-alert variant="custom" inline title="Custom alert title" />
...
</pf-alert>`},{default:t(()=>[e(i,{inline:"",variant:"success",title:"Success alert title",onClose:n[5]||(n[5]=a=>c("Clicked the close button"))},{"action-links":t(()=>[e(w,{onClick:n[3]||(n[3]=a=>c("Clicked on View details"))},{default:t(()=>[l("View details")]),_:1}),e(w,{onClick:n[4]||(n[4]=a=>c("Clicked on Ignore"))},{default:t(()=>[l("Ignore")]),_:1})]),default:t(()=>[te]),_:1})]),_:1}),e(r,{title:"Static live region",source:`<pf-alert
  live-region
  variant="info"
...
</pf-alert>`},{default:t(()=>[e(i,{title:"Custom alert title"},{"custom-icon":t(()=>[e(h(W))]),_:1}),e(i,{variant:"info",title:"Info alert title"},{"custom-icon":t(()=>[e(h(B))]),_:1}),e(i,{variant:"success",title:"Success alert title"},{"custom-icon":t(()=>[e(h(M))]),_:1}),e(i,{variant:"warning",title:"Warning alert title"},{"custom-icon":t(()=>[e(h(z))]),_:1}),e(i,{variant:"danger",title:"Danger alert title"},{"custom-icon":t(()=>[e(h(Y))]),_:1})]),_:1}),e(r,{title:"Static Alert Group",source:`<pf-alert-group>
...
</pf-alert-group>`},{default:t(()=>[e(k,null,{default:t(()=>[e(o,{variant:"secondary",onClick:n[15]||(n[15]=a=>m.push({title:"Toast Success Alert",variant:"success",key:u()}))},{default:t(()=>[l(" Add Toast Success Alert ")]),_:1}),e(o,{variant:"secondary",onClick:n[16]||(n[16]=a=>m.push({title:"Toast Info Alert",variant:"info",key:u()}))},{default:t(()=>[l(" Add Toast Info Alert ")]),_:1}),e(o,{variant:"secondary",onClick:n[17]||(n[17]=a=>m.push({title:"Toast Danger Alert",variant:"danger",key:u()}))},{default:t(()=>[l(" Add Toast Danger Alert ")]),_:1})]),_:1}),e(D,{toast:"","live-region":"","overflow-message":E.value,onOverflowClick:G},{default:t(()=>[(s(!0),d(f,null,T(m.slice(0,L),(a,V)=>(s(),b(i,{key:a.key,variant:a.variant,title:a.title,"live-region":"",onClose:O=>m.splice(V,1)},null,8,["variant","title","onClose"]))),128))]),_:1},8,["overflow-message"])]),_:1})]),_:1})}}}),oe=Z(ie,[["__scopeId","data-v-8a6e9175"]]);export{oe as default};
