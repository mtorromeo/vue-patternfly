import{G as d}from"./gear-icon-BaFwUQpV.js";import{g as y,a as u,c as x,o as c,w as n,d as g,b as t,e as l,t as o,u as m,_ as k}from"./index-CiyZyzwL.js";const T={style:{height:"80px"}},w=y({__name:"MenuToggle.story",setup(A){return(C,e)=>{const r=u("component-info"),a=u("pf-menu-toggle"),i=u("story-canvas"),b=u("pf-badge"),p=u("pf-menu-toggle-checkbox"),s=u("pf-menu-toggle-action"),f=u("pf-avatar"),v=u("doc-page");return c(),x(v,{name:"Components/MenuToggle.story.vue",title:"Menu toggle"},{description:n(()=>[...e[0]||(e[0]=[l("The ",-1),g("b",null,"menu toggle",-1),l(" component pairs with the menu OR the panel component to create more customizable dropdown and select implementations. Using a menu toggle with a menu enables you to create custom component configurations not supported by the standard dropdown or select components.",-1)])]),apidocs:n(()=>[t(r,{name:"PfMenuToggle",doc:{name:"PfMenuToggle",exportName:"PfMenuToggle",displayName:"MenuToggle",description:"",tags:{},expose:[{name:"el"},{name:"focus"}],props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"disabled",description:"Flag indicating the toggle is disabled",required:!1,type:{name:"boolean"}},{name:"fullHeight",description:"Flag indicating the toggle is full height",required:!1,type:{name:"boolean"}},{name:"fullWidth",description:"Flag indicating the toggle takes up the full width of its parent",required:!1,type:{name:"boolean"}},{name:"placeholder",description:"Flag indicating the toggle contains placeholder text",required:!1,type:{name:"boolean"}},{name:"settings",description:"Flag indicating whether the toggle is a settings toggle. This will override the icon property",required:!1,type:{name:"boolean"}},{name:"variant",description:"Variant styles of the menu toggle",required:!1,type:{name:"union",elements:[{name:'"default"'},{name:'"plain"'},{name:'"primary"'},{name:'"plainText"'},{name:'"secondary"'},{name:'"typeahead"'}]}},{name:"status",description:"Status styles of the menu toggle",required:!1,type:{name:"union",elements:[{name:'"success"'},{name:'"warning"'},{name:'"danger"'}]}},{name:"small",description:"Smaller size of the menu toggle",required:!1,type:{name:"boolean"}}],events:[],slots:[{name:"status-icon"},{name:"icon"},{name:"default"},{name:"split-buttons"},{name:"badge"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/MenuToggle/MenuToggle.vue"]}}),t(r,{name:"PfMenuToggleAction",doc:{name:"PfMenuToggleAction",exportName:"PfMenuToggleAction",displayName:"MenuToggleAction",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/MenuToggle/MenuToggleAction.vue"]}}),t(r,{name:"PfMenuToggleCheckbox",doc:{name:"PfMenuToggleCheckbox",exportName:"PfMenuToggleCheckbox",displayName:"MenuToggleCheckbox",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"checked",description:"Flag to show if the checkbox is checked. Use null to set the checkbox indeterminate state",required:!1,type:{name:"union",elements:[{name:"boolean"},{name:"null"}]}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/MenuToggle/MenuToggleCheckbox.vue"]}})]),default:n(()=>[e[73]||(e[73]=g("div",{class:"markdown pf-v6-c-content"},[g("h2",{class:"pf-v6-c-title"},"Examples")],-1)),t(i,{title:"Collapsed",source:"<pf-menu-toggle>Collapsed</pf-menu-toggle>"},{default:n(()=>[t(a,null,{default:n(()=>[...e[1]||(e[1]=[l("Collapsed",-1)])]),_:1})]),_:1}),t(i,{title:"Expanded",source:"<pf-menu-toggle expanded>Expanded</pf-menu-toggle>"},{default:n(()=>[t(a,{expanded:""},{default:n(()=>[...e[2]||(e[2]=[l("Expanded",-1)])]),_:1})]),_:1}),t(i,{title:"Disabled",source:"<pf-menu-toggle disabled>Disabled</pf-menu-toggle>"},{default:n(()=>[t(a,{disabled:""},{default:n(()=>[...e[3]||(e[3]=[l("Disabled",-1)])]),_:1})]),_:1}),t(i,{title:"Count",source:`<pf-menu-toggle>
  Count
  <template #badge>
...
</div>`},{default:n(()=>[g("div",T,[t(a,{"full-height":""},{default:n(()=>[...e[71]||(e[71]=[l("Full height",-1)])]),_:1})])]),_:1}),t(i,{title:"Full width",source:"<pf-menu-toggle full-width>Full width</pf-menu-toggle>"},{default:n(()=>[t(a,{"full-width":""},{default:n(()=>[...e[72]||(e[72]=[l("Full width",-1)])]),_:1})]),_:1})]),_:1})}}}),I=k(w,[["__scopeId","data-v-0b60c2cc"]]);export{I as default};
