import{e as r,r as o,a as v,c as g,w as i,o as S,b as e,g as a}from"./index.85f7ca3b.js";const y=r({__name:"Nav.story",setup(x){const t=o("link1"),p=o("dark"),m=o("default");function l(_,L,u){t.value=u}return(_,L)=>{const u=v("component-title"),n=v("pf-nav-item"),c=v("pf-nav-list"),k=v("pf-nav"),d=v("story-canvas"),f=v("pf-nav-group"),s=v("doc-page");return S(),g(s,{title:"Nav"},{default:i(()=>[e(u,{name:"pf-nav"}),e(d,{title:"Default",dark:p.value!=="light"&&m.value!=="tertiary","max-width":"300px",source:`<pf-nav>
  <pf-nav-list>
