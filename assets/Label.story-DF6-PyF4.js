import{C as i}from"./circle-info-icon-AI9DYCp_.js";import{g as w,m as c,a as u,c as v,o as g,w as e,b as o,d as f,e as n,u as a}from"./index-Bro5Nqn3.js";const y=w({__name:"Label.story",setup(C){const m=c();function r(d){var p;const l=(p=d.target)==null?void 0:p.closest(".pf-v6-c-label");l instanceof HTMLElement&&m.add({title:`Clicked close button on "${l.innerText}"`,variant:"info"})}return(d,l)=>{const p=u("component-info"),t=u("pf-label"),b=u("story-canvas"),s=u("doc-page");return g(),v(s,{name:"Components/Label.story.vue",title:"Label"},{description:e(()=>[...l[0]||(l[0]=[n("The ",-1),f("b",null,"label",-1),n(" component allows users to add specific element captions for user clarity and convenience.",-1)])]),apidocs:e(()=>[o(p,{src:"packages/core/src/components/Label.vue"})]),default:e(()=>[o(b,{title:"Filled",source:`<pf-label>Grey</pf-label>
<pf-label>
  <template #icon>
    <circle-info-icon />
  </template>Grey icon
