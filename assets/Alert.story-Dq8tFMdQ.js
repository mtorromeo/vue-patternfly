import{U as P,B as W,D as B,S as E,L as M}from"./laptop-icon-CPr6ZezP.js";import{g as z,r as V,h as _,i as Y,a as c,c as b,o as s,w as a,b as t,d as I,t as j,e as l,j as d,F as f,k as T,l as H,u as S,_ as J}from"./index-DCKv16MW.js";const $=4,K=z({__name:"Alert.story",setup(Q){const R=V("Alert text"),C=_([]),m=_([]),v=_([]),p=A=>window.alert(A),u=()=>new Date().getTime(),q=_([]);let D;const L=()=>{clearInterval(D)},N=()=>{D=setInterval(()=>{q.push({title:`This is a async alert number ${q.length+1}`,variant:"info",liveRegion:!0,key:u()})},1500)},g=V(!1),U=()=>console.log("Overflow message clicked"),F=Y(()=>{const A=m.length-$;return A>0?`View ${A} more alerts`:""});return(A,e)=>{const y=c("component-info"),i=c("pf-alert"),r=c("story-canvas"),w=c("pf-alert-action-link"),o=c("pf-button"),k=c("pf-input-group"),x=c("pf-alert-group"),O=c("doc-page");return s(),b(O,{name:"Components/Alert.story.vue",title:"Alert"},{description:a(()=>e[18]||(e[18]=[l("An "),I("b",null,"alert",-1),l(" is a notification that provides brief information to the user without blocking their workflow.")])),apidocs:a(()=>[t(y,{src:"packages/core/src/components/Alert/Alert.vue",doc:{name:"PfAlert",exportName:"default",displayName:"Alert",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"ariaLabel",description:"Adds accessible text to the alert.",required:!1,type:{name:"string"}},{name:"id",description:"Uniquely identifies the alert.",required:!1,type:{name:"string"}},{name:"expandable",description:"Flag indicating that the alert is expandable.",required:!1,type:{name:"boolean"}},{name:"onClose",description:"Show close button",required:!1,type:{name:"TSFunctionType"}},{name:"inline",description:"Flag to indicate if the alert is inline.",required:!1,type:{name:"boolean"}},{name:"liveRegion",description:"Flag to indicate if the alert is in a live region.",required:!1,type:{name:"boolean"}},{name:"plain",description:"Flag to indicate if the alert is plain.",required:!1,type:{name:"boolean"}},{name:"timeout",description:`If set to true, the timeout is 8000 milliseconds. If a number is provided, alert will
...
<pf-alert variant="danger" title="Danger alert title" />`},{default:a(()=>[t(i,{title:"Custom alert title"}),t(i,{variant:"info",title:"Info alert title"}),t(i,{variant:"success",title:"Success alert title"}),t(i,{variant:"warning",title:"Warning alert title"}),t(i,{variant:"danger",title:"Danger alert title"})]),_:1}),t(r,{title:"With action links",source:`<pf-alert title="Alert title" @close="alert('Clicked the close button')">
  ...
  <p>{{ sample_text }}</p>
</pf-alert>`},{default:a(()=>[t(i,{title:"Alert title",onClose:e[2]||(e[2]=n=>p("Clicked the close button"))},{"action-links":a(()=>[t(w,{onClick:e[0]||(e[0]=n=>p("Clicked on View details"))},{default:a(()=>e[19]||(e[19]=[l("View details")])),_:1,__:[19]}),t(w,{onClick:e[1]||(e[1]=n=>p("Clicked on Ignore"))},{default:a(()=>e[20]||(e[20]=[l("Ignore")])),_:1,__:[20]})]),default:a(()=>[I("p",null,j(R.value),1)]),_:1})]),_:1}),t(r,{title:"Inline types",source:`<pf-alert variant="custom" inline title="Custom alert title" />
...
</pf-alert>`},{default:a(()=>[t(i,{inline:"",variant:"success",title:"Success alert title",onClose:e[5]||(e[5]=n=>p("Clicked the close button"))},{"action-links":a(()=>[t(w,{onClick:e[3]||(e[3]=n=>p("Clicked on View details"))},{default:a(()=>e[21]||(e[21]=[l("View details")])),_:1,__:[21]}),t(w,{onClick:e[4]||(e[4]=n=>p("Clicked on Ignore"))},{default:a(()=>e[22]||(e[22]=[l("Ignore")])),_:1,__:[22]})]),default:a(()=>[e[23]||(e[23]=I("p",null,"Success alert description. This should tell the user more information about the alert.",-1))]),_:1,__:[23]})]),_:1}),t(r,{title:"Static live region",source:`<pf-alert
  live-region
  variant="info"
...
</pf-alert>`},{default:a(()=>[t(i,{"live-region":"",variant:"info",title:"Default live region configuration",onClose:e[6]||(e[6]=n=>p("Clicked the close button"))},{default:a(()=>e[24]||(e[24]=[l(" This Alert uses the recommended "),I("code",null,"live-region",-1),l(" prop to automatically sets ARIA attributes and CSS classes. ")])),_:1,__:[24]}),t(i,{"aria-live":"assertive","aria-relevant":"additions text","aria-atomic":"true",variant:"info",title:"Customized live region",onClose:e[7]||(e[7]=n=>p("Clicked the close button"))},{default:a(()=>e[25]||(e[25]=[l(" You can alternatively omit the "),I("code",null,"live-region",-1),l(" prop to specify ARIA attributes and CSS manually on the containing element. ")])),_:1,__:[25]})]),_:1}),t(r,{title:"Dynamic live region",source:`<pf-input-group style="margin-bottom: 16px">
  <pf-button
    variant="secondary"
    @click="alerts.push({
...
<pf-alert
  ...
  :aria-atomic="a.ariaAtomic" />`},{default:a(()=>[t(k,{style:{"margin-bottom":"16px"}},{default:a(()=>[t(o,{variant:"secondary",onClick:e[8]||(e[8]=n=>C.push({title:"Single Success Alert",variant:"success",liveRegion:!0,key:u()}))},{default:a(()=>e[26]||(e[26]=[l(" Add Single Success Alert ")])),_:1,__:[26]}),t(o,{variant:"secondary",onClick:e[9]||(e[9]=n=>C.push({title:"Single Info Alert",variant:"info",liveRegion:!0,key:u()}))},{default:a(()=>e[27]||(e[27]=[l(" Add Single Info Alert ")])),_:1,__:[27]}),t(o,{variant:"secondary",onClick:e[10]||(e[10]=n=>C.push({title:"Single Danger Alert",variant:"danger",ariaLive:"assertive",ariaRelevant:"additions text",ariaAtomic:"false",key:u()}))},{default:a(()=>e[28]||(e[28]=[l(" Add Single Danger Alert ")])),_:1,__:[28]})]),_:1}),(s(!0),d(f,null,T(C,n=>(s(),b(i,{key:n.key,variant:n.variant,title:n.title,"live-region":n.liveRegion,"aria-live":n.ariaLive,"aria-relevant":n.ariaRelevant,"aria-atomic":n.ariaAtomic},null,8,["variant","title","live-region","aria-live","aria-relevant","aria-atomic"]))),128))]),_:1}),t(r,{title:"Async live region",source:`<pf-input-group style="margin-bottom: 16px">
...
<pf-alert
  ...
  :variant="a.variant"
  :title="a.title"
  :live-region="a.liveRegion" />`},{default:a(()=>[t(k,{style:{"margin-bottom":"16px"}},{default:a(()=>[t(o,{variant:"secondary",onClick:N},{default:a(()=>e[29]||(e[29]=[l("Start Async Info Alerts")])),_:1,__:[29]}),t(o,{variant:"secondary",onClick:L},{default:a(()=>e[30]||(e[30]=[l("Stop Async Info Alerts")])),_:1,__:[30]})]),_:1}),(s(!0),d(f,null,T(q,n=>(s(),b(i,{key:n.key,variant:n.variant,title:n.title,"live-region":n.liveRegion},null,8,["variant","title","live-region"]))),128))]),_:1}),t(r,{title:"Alert timeout",source:`<pf-input-group style="margin-bottom: 16px">
  <pf-button
    variant="secondary"
...
</pf-input-group>`},{default:a(()=>[t(k,{style:{"margin-bottom":"16px"}},{default:a(()=>[t(o,{variant:"secondary",disabled:g.value,onClick:e[11]||(e[11]=n=>g.value=!g.value)},{default:a(()=>[g.value?(s(),d(f,{key:0},[l("0 alerts to show")],64)):(s(),d(f,{key:1},[l("Show 2 alerts")],64))]),_:1},8,["disabled"])]),_:1}),g.value?(s(),d(f,{key:0},[t(i,{title:"Default timeout Alert",timeout:""},{default:a(()=>e[31]||(e[31]=[l(" This alert will dismiss after 8 seconds ")])),_:1,__:[31]}),t(i,{title:"Custom timeout Alert",timeout:16e3},{default:a(()=>e[32]||(e[32]=[l(" This alert will dismiss after 16 seconds ")])),_:1,__:[32]})],64)):H("",!0)]),_:1}),t(r,{title:"Custom icons",source:`<pf-alert title="Custom alert title">
...
</pf-alert-group>`},{default:a(()=>[t(x,null,{default:a(()=>[t(i,{title:"Success Alert",variant:"success",inline:""}),t(i,{title:"Info Alert",variant:"info",inline:""})]),_:1})]),_:1}),t(r,{title:"Toast",source:`<pf-input-group>
  <pf-button
    variant="secondary"
    @click="alerts3.push({
...
</pf-alert-group>`},{default:a(()=>[t(k,null,{default:a(()=>[t(o,{variant:"secondary",onClick:e[12]||(e[12]=n=>v.push({title:"Toast Success Alert",variant:"success",key:u()}))},{default:a(()=>e[33]||(e[33]=[l(" Add Toast Success Alert ")])),_:1,__:[33]}),t(o,{variant:"secondary",onClick:e[13]||(e[13]=n=>v.push({title:"Toast Info Alert",variant:"info",key:u()}))},{default:a(()=>e[34]||(e[34]=[l(" Add Toast Info Alert ")])),_:1,__:[34]}),t(o,{variant:"secondary",onClick:e[14]||(e[14]=n=>v.push({title:"Toast Danger Alert",variant:"danger",key:u()}))},{default:a(()=>e[35]||(e[35]=[l(" Add Toast Danger Alert ")])),_:1,__:[35]})]),_:1}),t(x,{toast:""},{default:a(()=>[(s(!0),d(f,null,T(v,(n,h)=>(s(),b(i,{key:n.key,variant:n.variant,title:n.title,"live-region":"",onClose:G=>v.splice(h,1)},null,8,["variant","title","onClose"]))),128))]),_:1})]),_:1}),t(r,{title:"Toast with overflow capture",source:`<pf-input-group>
  <pf-button
    variant="secondary"
    @click="alerts2.push({
      title: 'Toast Success Alert',
...
</pf-alert-group>`},{default:a(()=>[t(k,null,{default:a(()=>[t(o,{variant:"secondary",onClick:e[15]||(e[15]=n=>m.push({title:"Toast Success Alert",variant:"success",key:u()}))},{default:a(()=>e[36]||(e[36]=[l(" Add Toast Success Alert ")])),_:1,__:[36]}),t(o,{variant:"secondary",onClick:e[16]||(e[16]=n=>m.push({title:"Toast Info Alert",variant:"info",key:u()}))},{default:a(()=>e[37]||(e[37]=[l(" Add Toast Info Alert ")])),_:1,__:[37]}),t(o,{variant:"secondary",onClick:e[17]||(e[17]=n=>m.push({title:"Toast Danger Alert",variant:"danger",key:u()}))},{default:a(()=>e[38]||(e[38]=[l(" Add Toast Danger Alert ")])),_:1,__:[38]})]),_:1}),t(x,{toast:"","live-region":"","overflow-message":F.value,onOverflowClick:U},{default:a(()=>[(s(!0),d(f,null,T(m.slice(0,$),(n,h)=>(s(),b(i,{key:n.key,variant:n.variant,title:n.title,"live-region":"",onClose:G=>m.splice(h,1)},null,8,["variant","title","onClose"]))),128))]),_:1},8,["overflow-message"])]),_:1})]),_:1})}}}),ee=J(K,[["__scopeId","data-v-015ce664"]]);export{ee as default};
