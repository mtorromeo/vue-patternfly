import{B as y}from"./bell-icon-AI43jolk.js";import{C as T}from"./cubes-icon-nVLgTA3E.js";import{m as G,e as H,n as h,r,a as f,o as z,c as I,w as o,b as n,g as e,u}from"./index-aHpSD51e.js";import{E as U}from"./ellipsis-vertical-icon-pX4Wm7yY.js";const B={name:"TableCellsIcon",height:512,width:512,svgPath:"M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm88 64v64H64V96h88zm56 0h88v64H208V96zm240 0v64H360V96h88zM64 224h88v64H64V224zm232 0v64H208V224h88zm64 0h88v64H360V224zM152 352v64H64V352h88zm56 0h88v64H208V352zm240 0v64H360V352h88z",yOffset:0,xOffset:0},M=G(B),W=M,j=H({__name:"Dropdown.story",setup(E){const x=h();function m(c){c.target instanceof HTMLElement&&x.add({title:`Clicked "${c.target.innerText}"`})}const w=r(!1),b=r(!1),_=r(!1),k=r(!1),A=r(!1),v=r(!1),L=r(!1),D=r(!1),g=r(!1);return(c,d)=>{const C=f("component-title"),t=f("pf-dropdown-item"),i=f("pf-divider"),l=f("pf-dropdown"),a=f("story-canvas"),S=f("pf-menu-toggle"),s=f("pf-dropdown-group"),V=f("doc-page");return z(),I(V,{title:"Dropdown"},{default:o(()=>[n(C,{name:"pf-dropdown"}),n(a,{title:"Basic",source:`<pf-dropdown v-model:open="open1" text="Dropdown">
