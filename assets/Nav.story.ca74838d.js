import{e as r,r as s,a as v,c as h,w as i,o as g,b as t,j as a}from"./index.0b6ec288.js";const S=a(" Link 1 "),x=a(" Link 2 "),y=a(" Link 3 "),w=a(" Link 4 "),b=a(" Link 5 "),C=a(" Link 1 "),N=a(" Link 2 "),B=a(" Link 3 "),V=a(" Link 4 "),j=a(" Link 5 "),D=a(" Link 6 "),F=a(" Link 1 "),G=a(" Link 2 "),T=a(" Link 3 \\ "),q=a(" Link 7 "),z=a(" Link 4 "),A=a(" Link 5 "),E=a(" Link 6 "),J=r({setup(H){const e=s("link1"),f=s("dark"),d=s("default");function l(m,u,p){e.value=p}return(m,u)=>{const p=v("component-title"),n=v("pf-nav-item"),k=v("pf-nav-list"),c=v("pf-nav"),_=v("story-canvas"),o=v("pf-nav-group"),L=v("doc-page");return g(),h(L,{title:"Nav"},{default:i(()=>[t(p,{name:"pf-nav"}),t(_,{title:"Default",dark:f.value!=="light"&&d.value!=="tertiary","max-width":"300px",source:`<pf-nav>
  <pf-nav-list>
