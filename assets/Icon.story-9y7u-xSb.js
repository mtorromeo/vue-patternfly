...
</pf-icon>`},{default:e(()=>[c("div",W,[n(h,{modelValue:f.value,"onUpdate:modelValue":p[1]||(p[1]=d=>f.value=d),label:"Toggle in progress state","aria-label":"Set icon progress state"},null,8,["modelValue"])]),n(o,{"in-progress":f.value},{progressIcon:e(()=>[n(C,{diameter:"2em","aria-label":"Loading..."})]),default:e(()=>[n(i(g))]),_:1},8,["in-progress"])]),_:1})]),_:1},8,["name"])}}});export{cn as default};
