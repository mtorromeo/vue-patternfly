import{e as k,r as m,c as d,w as e,a as n,o as u,b as t,g as y,h as T,F as I,j as c}from"./index.4a516379.js";const b=c(" Add Toast Success Alert "),C=c(" Add Toast Info Alert "),S=c(" Add Toast Danger Alert "),U=k({name:"AlertGroup.story",setup(h){const r=m([]),s=()=>new Date().getTime();return(x,a)=>{const _=n("component-title"),l=n("pf-alert"),p=n("pf-alert-group"),f=n("story-canvas"),i=n("pf-button"),v=n("pf-input-group"),g=n("doc-page");return u(),d(g,{title:"Alert Group"},{default:e(()=>[t(_,{name:"pf-alert-group"}),t(f,{title:"Static",source:`<pf-alert-group>
