import{g as m,a as u,c as M,o as y,w as a,d as n,b as e,e as l}from"./index-CiyZyzwL.js";const g=m({__name:"Panel.story",setup(v){return(P,t)=>{const s=u("component-info"),p=u("pf-panel-main-body"),o=u("pf-panel-main"),r=u("pf-panel"),i=u("story-canvas"),d=u("pf-panel-header"),f=u("pf-divider"),c=u("pf-panel-footer"),b=u("doc-page");return y(),M(b,{name:"Components/Panel.story.vue",title:"Panel"},{description:a(()=>[...t[0]||(t[0]=[l("The ",-1),n("b",null,"panel",-1),l(" component is a container that supports flexible content layouts. It can be used to house other components such as fields, forms, videos, buttons, and more. The panel should not be confused with the drawer component, which allows you to surface information via a collapsable container.",-1)])]),apidocs:a(()=>[e(s,{name:"PfPanel",doc:{name:"PfPanel",exportName:"PfPanel",displayName:"Panel",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"variant",description:"Adds panel variant styles",required:!1,type:{name:"union",elements:[{name:'"raised"'},{name:'"bordered"'}]}},{name:"scrollable",description:"Flag to add scrollable styling to the panel",required:!1,type:{name:"boolean"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Panel/Panel.vue"]}}),e(s,{name:"PfPanelFooter",doc:{name:"PfPanelFooter",exportName:"PfPanelFooter",displayName:"PanelFooter",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Panel/PanelFooter.vue"]}}),e(s,{name:"PfPanelHeader",doc:{name:"PfPanelHeader",exportName:"PfPanelHeader",displayName:"PanelHeader",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Panel/PanelHeader.vue"]}}),e(s,{name:"PfPanelMain",doc:{name:"PfPanelMain",exportName:"PfPanelMain",displayName:"PanelMain",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"maxHeight",description:"Max height of the panel main div as a string with the value and unit",required:!1,type:{name:"string"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Panel/PanelMain.vue"]}}),e(s,{name:"PfPanelMainBody",doc:{name:"PfPanelMainBody",exportName:"PfPanelMainBody",displayName:"PanelMainBody",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Panel/PanelMainBody.vue"]}})]),default:a(()=>[t[16]||(t[16]=n("div",{class:"markdown pf-v6-c-content"},[n("h2",{class:"pf-v6-c-title"},"Examples")],-1)),e(i,{title:"Basic",source:`<pf-panel>
  <pf-panel-main>
