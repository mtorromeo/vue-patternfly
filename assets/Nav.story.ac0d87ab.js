import{e as r,r as s,a as v,o as h,c as g,w as i,b as t,j as a}from"./index.61b3793e.js";const S=a(" Link 1 "),x=a(" Link 2 "),y=a(" Link 3 "),w=a(" Link 4 "),N=a(" Link 5 "),b=a(" Link 1 "),C=a(" Link 2 "),B=a(" Link 3 "),V=a(" Link 4 "),j=a(" Link 5 "),D=a(" Link 6 "),F=a(" Link 1 "),G=a(" Link 2 "),T=a(" Link 3 \\ "),q=a(" Link 7 "),z=a(" Link 4 "),A=a(" Link 5 "),E=a(" Link 6 "),J=r({__name:"Nav.story",setup(H){const e=s("link1"),f=s("dark"),d=s("default");function l(m,u,p){e.value=p}return(m,u)=>{const p=v("component-title"),n=v("pf-nav-item"),k=v("pf-nav-list"),c=v("pf-nav"),_=v("story-canvas"),o=v("pf-nav-group"),L=v("doc-page");return h(),g(L,{title:"Nav"},{default:i(()=>[t(p,{name:"pf-nav"}),t(_,{title:"Default",dark:f.value!=="light"&&d.value!=="tertiary","max-width":"300px",source:`<pf-nav>
  <pf-nav-list>
