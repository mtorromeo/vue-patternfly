import{C as d}from"./cubes-icon-b053e463.js";import{m as h,e as b,a as n,o as v,c as g,w as e,b as t,u as r,g as a}from"./index-9df331c0.js";import{M as k}from"./magnifying-glass-icon-fe6fbe67.js";const C={name:"CheckIcon",height:512,width:448,svgPath:"M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z",yOffset:0,xOffset:0},x=h(C),I=x,A=b({__name:"EmptyState.story",setup(N){return(P,w)=>{const u=n("component-title"),p=n("pf-empty-state-header"),i=n("pf-empty-state-body"),o=n("pf-button"),f=n("pf-empty-state-actions"),c=n("pf-empty-state-footer"),l=n("pf-empty-state"),s=n("story-canvas"),y=n("pf-spinner"),m=n("pf-empty-state-icon"),_=n("doc-page");return v(),g(_,{title:"Empty State"},{default:e(()=>[t(u,{name:"pf-empty-state"}),t(s,{title:"Example",source:`<pf-empty-state>
