import{e as x,f as y,l as $,a as o,o as c,c as A,w as e,b as t,g as i,h as _,i as T,F as m}from"./index-aaYEbCQ_.js";const I=4,h=x({__name:"AlertGroup.story",setup(q){const u=y([]),r=()=>new Date().getTime(),l=y([]),w=()=>console.log("Overflow message clicked"),b=$(()=>{const f=l.length-I;return f>0?`View ${f} more alerts`:""});return(f,n)=>{const C=o("component-title"),p=o("pf-alert"),d=o("pf-alert-group"),v=o("story-canvas"),s=o("pf-button"),k=o("pf-input-group"),D=o("doc-page");return c(),A(D,{title:"Alert Group"},{default:e(()=>[t(C,{name:"pf-alert-group"}),t(v,{title:"Static",source:`<pf-alert-group>
