import{e as k,r as m,a as n,c as d,w as e,o as c,b as t,g as y,h as T,F as I,j as u}from"./index.d06ccf2e.js";const C=u(" Add Toast Success Alert "),S=u(" Add Toast Info Alert "),b=u(" Add Toast Danger Alert "),U=k({__name:"AlertGroup.story",setup(h){const r=m([]),l=()=>new Date().getTime();return(x,a)=>{const _=n("component-title"),s=n("pf-alert"),p=n("pf-alert-group"),f=n("story-canvas"),i=n("pf-button"),v=n("pf-input-group"),g=n("doc-page");return c(),d(g,{title:"Alert Group"},{default:e(()=>[t(_,{name:"pf-alert-group"}),t(f,{title:"Static",source:`<pf-alert-group>
