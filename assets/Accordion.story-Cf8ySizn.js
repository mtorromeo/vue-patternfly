import{r as c,a as r,c as f,o as v,w as t,b as a,d as u,e as m}from"./index-CiyZyzwL.js";const q={__name:"Accordion.story",setup(x){const n=c(null);return(b,e)=>{const d=r("component-info"),o=r("pf-accordion-item"),l=r("pf-accordion"),s=r("story-canvas"),p=r("doc-page");return v(),f(p,{name:"Components/Accordion.story.vue",title:"Accordion"},{description:t(()=>[...e[10]||(e[10]=[m("An ",-1),u("b",null,"accordion",-1),m(" is an interactive container that expands and collapses to hide or reveal nested content. It takes advantage of progressive disclosure to help reduce page scrolling, by allowing users to choose whether they want to show or hide more detailed information as needed.",-1)])]),apidocs:t(()=>[a(d,{name:"PfAccordion",doc:{name:"PfAccordion",exportName:"PfAccordion",displayName:"Accordion",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"level",description:"Heading level to use",required:!1,type:{name:"union",elements:[{name:'"h1"'},{name:'"h2"'},{name:'"h3"'},{name:'"h4"'},{name:'"h5"'},{name:'"h6"'},{name:"number"}]},defaultValue:{func:!1,value:"3"}},{name:"dl",description:"Flag to indicate whether use definition list or div",required:!1,type:{name:"boolean"}},{name:"bordered",description:"Flag to indicate the accordion had a border",required:!1,type:{name:"boolean"}},{name:"large",description:"Large display size variant.",required:!1,type:{name:"boolean"}},{name:"togglePosition",description:"Sets the toggle icon position for all accordion toggles.",required:!1,type:{name:"union",elements:[{name:'"start"'},{name:'"end"'}]},defaultValue:{func:!1,value:"'end'"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Accordion/Accordion.vue"]}}),a(d,{name:"PfAccordionItem",doc:{name:"PfAccordionItem",exportName:"PfAccordionItem",displayName:"AccordionItem",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"title",required:!1,type:{name:"string"}},{name:"toggleComponent",required:!1,type:{name:"string"}},{name:"contentComponent",required:!1,type:{name:"string"}},{name:"fixed",required:!1,type:{name:"boolean"}}],events:[{name:"click",type:{names:["PointerEvent"]}}],slots:[{name:"toggle"},{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Accordion/AccordionItem.vue"]}})]),default:t(()=>[a(s,{title:"Default",source:`<pf-accordion>
  <pf-accordion-item
    title="Item One"
    :expanded="expanded == 1"
