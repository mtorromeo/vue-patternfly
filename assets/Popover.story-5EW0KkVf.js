...
</pf-popover>`},{default:o(()=>[n(c,{"append-to":"body"},{header:o(()=>[m]),body:o(()=>[u]),footer:o(()=>[t(" Popover footer ")]),default:o(()=>[n(a,null,{default:o(()=>[t("Toggle popover")]),_:1})]),_:1})]),_:1})]),_:1})}const P=i(v,[["render",h]]);export{P as default};
