import{U as W,B,D as U,S as q,L as N}from"./laptop-icon-e32e5f86.js";import{e as z,r as h,f as x,a as c,o as s,c as C,w as e,b as t,g as l,d as _,t as F,h as f,i as D,F as d,j as Y,u as v,p as j,k as E,_ as G}from"./index-9df331c0.js";const S=m=>(j("data-v-f376ebbe"),m=m(),E(),m),H=S(()=>_("p",null,"Success alert description. This should tell the user more information about the alert.",-1)),J=S(()=>_("code",null,"live-region",-1)),K=S(()=>_("code",null,"live-region",-1)),M=z({__name:"Alert.story",setup(m){const R=h("Alert text"),g=x([]),o=w=>window.alert(w),k=()=>new Date().getTime(),A=x([]);let I;const T=()=>{clearInterval(I)},$=()=>{I=setInterval(()=>{A.push({title:`This is a async alert number ${A.length+1}`,variant:"info",liveRegion:!0,key:k()})},1500)},p=h(!1);return(w,i)=>{const V=c("component-title"),a=c("pf-alert"),r=c("story-canvas"),y=c("pf-alert-action-link"),u=c("pf-button"),b=c("pf-input-group"),L=c("doc-page");return s(),C(L,{title:"Alert"},{default:e(()=>[t(V,{name:"pf-alert"}),t(r,{title:"Types",source:`<pf-alert title="Custom alert title" />
...
<pf-alert variant="danger" title="Danger alert title" />`},{default:e(()=>[t(a,{title:"Custom alert title"}),t(a,{variant:"info",title:"Info alert title"}),t(a,{variant:"success",title:"Success alert title"}),t(a,{variant:"warning",title:"Warning alert title"}),t(a,{variant:"danger",title:"Danger alert title"})]),_:1}),t(r,{title:"With action links",source:`<pf-alert title="Alert title" @close="alert('Clicked the close button')">
  ...
  <p>{{ sample_text }}</p>
</pf-alert>`},{default:e(()=>[t(a,{title:"Alert title",onClose:i[2]||(i[2]=n=>o("Clicked the close button"))},{"action-links":e(()=>[t(y,{onClick:i[0]||(i[0]=n=>o("Clicked on View details"))},{default:e(()=>[l("View details")]),_:1}),t(y,{onClick:i[1]||(i[1]=n=>o("Clicked on Ignore"))},{default:e(()=>[l("Ignore")]),_:1})]),default:e(()=>[_("p",null,F(R.value),1)]),_:1})]),_:1}),t(r,{title:"Inline types",source:`<pf-alert variant="custom" inline title="Custom alert title" />
...
</pf-alert>`},{default:e(()=>[t(a,{inline:"",variant:"success",title:"Success alert title",onClose:i[5]||(i[5]=n=>o("Clicked the close button"))},{"action-links":e(()=>[t(y,{onClick:i[3]||(i[3]=n=>o("Clicked on View details"))},{default:e(()=>[l("View details")]),_:1}),t(y,{onClick:i[4]||(i[4]=n=>o("Clicked on Ignore"))},{default:e(()=>[l("Ignore")]),_:1})]),default:e(()=>[H]),_:1})]),_:1}),t(r,{title:"Static live region",source:`<pf-alert
  live-region
  variant="info"
...
<pf-alert
  ...
  :aria-atomic="a.ariaAtomic" />`},{default:e(()=>[t(b,{style:{"margin-bottom":"16px"}},{default:e(()=>[t(u,{variant:"secondary",onClick:i[8]||(i[8]=n=>g.push({title:"Single Success Alert",variant:"success",liveRegion:!0,key:k()}))},{default:e(()=>[l(" Add Single Success Alert ")]),_:1}),t(u,{variant:"secondary",onClick:i[9]||(i[9]=n=>g.push({title:"Single Info Alert",variant:"info",liveRegion:!0,key:k()}))},{default:e(()=>[l(" Add Single Info Alert ")]),_:1}),t(u,{variant:"secondary",onClick:i[10]||(i[10]=n=>g.push({title:"Single Danger Alert",variant:"danger",ariaLive:"assertive",ariaRelevant:"additions text",ariaAtomic:"false",key:k()}))},{default:e(()=>[l(" Add Single Danger Alert ")]),_:1})]),_:1}),(s(!0),f(d,null,D(g,n=>(s(),C(a,{key:n.key,variant:n.variant,title:n.title,"live-region":n.liveRegion,"aria-live":n.ariaLive,"aria-relevant":n.ariaRelevant,"aria-atomic":n.ariaAtomic},null,8,["variant","title","live-region","aria-live","aria-relevant","aria-atomic"]))),128))]),_:1}),t(r,{title:"Async live region",source:`<pf-input-group style="margin-bottom: 16px">
...
<pf-alert
  ...
  :variant="a.variant"
  :title="a.title"
  :live-region="a.liveRegion" />`},{default:e(()=>[t(b,{style:{"margin-bottom":"16px"}},{default:e(()=>[t(u,{variant:"secondary",onClick:$},{default:e(()=>[l("Start Async Info Alerts")]),_:1}),t(u,{variant:"secondary",onClick:T},{default:e(()=>[l("Stop Async Info Alerts")]),_:1})]),_:1}),(s(!0),f(d,null,D(A,n=>(s(),C(a,{key:n.key,variant:n.variant,title:n.title,"live-region":n.liveRegion},null,8,["variant","title","live-region"]))),128))]),_:1}),t(r,{title:"Alert timeout",source:`<pf-input-group style="margin-bottom: 16px">
  <pf-button
    variant="secondary"
...
</pf-input-group>`},{default:e(()=>[t(b,{style:{"margin-bottom":"16px"}},{default:e(()=>[t(u,{variant:"secondary",disabled:p.value,onClick:i[11]||(i[11]=n=>p.value=!p.value)},{default:e(()=>[p.value?(s(),f(d,{key:0},[l("0 alerts to show")],64)):(s(),f(d,{key:1},[l("Show 2 alerts")],64))]),_:1},8,["disabled"])]),_:1}),p.value?(s(),f(d,{key:0},[t(a,{title:"Default timeout Alert",timeout:""},{default:e(()=>[l(" This alert will dismiss after 8 seconds ")]),_:1}),t(a,{title:"Custom timeout Alert",timeout:16e3},{default:e(()=>[l(" This alert will dismiss after 16 seconds ")]),_:1})],64)):Y("",!0)]),_:1}),t(r,{title:"Custom icons",source:`<pf-alert title="Custom alert title">
