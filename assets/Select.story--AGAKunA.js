...
</pf-select>`},{default:a(()=>[e(l,null,{default:a(()=>[(c(!0),b(k,null,g(y,(S,v)=>(c(),p(u,{key:v,label:v},{default:a(()=>[(c(!0),b(k,null,g(S,r=>(c(),p(t,{key:r.value,favorited:r.favorite,"onUpdate:favorited":q=>r.favorite=q,value:r.value,description:r.description,disabled:r.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1})]),_:1},8,["name"])}}});export{A as default};
