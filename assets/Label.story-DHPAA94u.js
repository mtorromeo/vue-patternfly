import{C as t}from"./circle-info-icon-CSOo6sZ3.js";import{f as m,n as h,o as _,c as v,w as e,a as o,b as l,u as r,d as c,e as p}from"./index-DQdJ4HZU.js";const g=c("b",null,"label",-1),C=c("br",null,null,-1),w=c("br",null,null,-1),y=c("br",null,null,-1),G=c("br",null,null,-1),x=c("br",null,null,-1),k=c("br",null,null,-1),B=c("br",null,null,-1),O=c("br",null,null,-1),P=c("br",null,null,-1),R=c("br",null,null,-1),q=c("br",null,null,-1),L=c("br",null,null,-1),T=c("br",null,null,-1),V=c("br",null,null,-1),S=c("br",null,null,-1),F=c("br",null,null,-1),N=c("br",null,null,-1),A=c("br",null,null,-1),I=c("br",null,null,-1),M=c("br",null,null,-1),E=c("br",null,null,-1),H=c("br",null,null,-1),W=c("br",null,null,-1),$=c("br",null,null,-1),j=c("br",null,null,-1),z=c("br",null,null,-1),D=c("br",null,null,-1),J=c("br",null,null,-1),X=m({__name:"Label.story",setup(K){const d=h();function a(u){var i;const b=(i=u.target)==null?void 0:i.closest(".pf-v5-c-label");b instanceof HTMLElement&&d.add({title:`Clicked close button on "${b.innerText}"`,variant:"info"})}return(u,b)=>{const i=p("component-info"),n=p("pf-label"),f=p("story-canvas"),s=p("doc-page");return _(),v(s,{name:"Components/Label.story.vue",title:"Label"},{description:e(()=>[o("The "),g,o(" component allows users to add specific element captions for user clarity and convenience.")]),apidocs:e(()=>[l(i,{src:"packages/core/src/components/Label.vue",doc:{name:"PfLabel",exportName:"default",displayName:"Label",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"color",description:"The color of the label outline/fill",required:!1,type:{name:"union",elements:[{name:'"blue"'},{name:'"cyan"'},{name:'"green"'},{name:'"orange"'},{name:'"purple"'},{name:'"red"'},{name:'"gold"'},{name:'"grey"'}]},defaultValue:{func:!1,value:"'grey'"}},{name:"variant",required:!1,type:{name:"union",elements:[{name:'"outline"'},{name:'"filled"'}]},defaultValue:{func:!1,value:"'filled'"}},{name:"tooltipPosition",required:!1,type:{name:"Placement"},defaultValue:{func:!1,value:"'top'"}},{name:"to",required:!1,type:{name:"RouteLocationRaw"}},{name:"href",required:!1,type:{name:"string"}},{name:"outline",required:!1,type:{name:"boolean"}},{name:"compact",description:"Flag indicating the label is compact.",required:!1,type:{name:"boolean"}},{name:"overflow",description:"Flag indicating if the label is an overflow label.",required:!1,type:{name:"boolean"}},{name:"textMaxWidth",description:"The max width of the label before it is truncated. Can be any valid CSS unit, such as '100%', '100px', or '16ch'.",required:!1,type:{name:"string"}},{name:"closeBtnAriaLabel",description:"Aria label for close button",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Close'"}},{name:"onClose",description:"Callback for when the label is clicked. This should not be passed in if the href or editable props are also passed in.",required:!1,type:{name:"TSFunctionType"}}],slots:[{name:"icon"},{name:"default"},{name:"actions"}],sourceFiles:["../../packages/core/src/components/Label.vue"]}})]),default:e(()=>[l(f,{title:"Filled",source:`<pf-label>Grey</pf-label>
<pf-label>
  <template #icon>
    <circle-info-icon />
  </template>Grey icon
