import{G as c}from"./gear-icon-6708cce4.js";import{E as r}from"./ellipsis-vertical-icon-1d55abce.js";import{e as v,a as p,o as x,c as y,w as t,b as e,g as a,t as l,u,d as g,p as h,k,_ as A}from"./index-a471940d.js";const C=s=>(h("data-v-33033df3"),s=s(),k(),s),w=C(()=>g("div",{class:"markdown pf-v5-c-content"},[g("p",null,[a("The "),g("strong",null,"menu toggle"),a(" component pairs with the menu OR the panel component to create more customizable dropdown and select implementations. Using a menu toggle with a menu enables you to create custom component configurations not supported by the standard dropdown or select components.")]),g("h2",{class:"pf-v5-c-title"},"Examples")],-1)),I={style:{height:"80px"}},S=v({__name:"MenuToggle.story",setup(s){return(T,D)=>{const m=p("component-title"),n=p("pf-menu-toggle"),o=p("story-canvas"),_=p("pf-badge"),i=p("pf-menu-toggle-checkbox"),d=p("pf-menu-toggle-action"),f=p("pf-avatar"),b=p("doc-page");return x(),y(b,{title:"Menu toggle"},{default:t(()=>[e(m,{name:"pf-menu-toggle"}),w,e(o,{title:"Collapsed",source:"<pf-menu-toggle>Collapsed</pf-menu-toggle>"},{default:t(()=>[e(n,null,{default:t(()=>[a("Collapsed")]),_:1})]),_:1}),e(o,{title:"Expanded",source:"<pf-menu-toggle expanded>Expanded</pf-menu-toggle>"},{default:t(()=>[e(n,{expanded:""},{default:t(()=>[a("Expanded")]),_:1})]),_:1}),e(o,{title:"Disabled",source:"<pf-menu-toggle disabled>Disabled</pf-menu-toggle>"},{default:t(()=>[e(n,{disabled:""},{default:t(()=>[a("Disabled")]),_:1})]),_:1}),e(o,{title:"Count",source:`<pf-menu-toggle>
  Count
  <template #badge>
...
{{ ' ' }}
<pf-menu-toggle variant="secondary" disabled>Disabled</pf-menu-toggle>`},{default:t(()=>[e(n,{variant:"secondary"},{default:t(()=>[a("Collapsed")]),_:1}),a(" "+l(" ")+" "),e(n,{variant:"secondary"},{icon:t(()=>[e(u(c))]),default:t(()=>[a(" Icon ")]),_:1}),a(" "+l(" ")+" "),e(n,{variant:"secondary",expanded:""},{default:t(()=>[a("Expanded")]),_:1}),a(" "+l(" ")+" "),e(n,{variant:"secondary",disabled:""},{default:t(()=>[a("Disabled")]),_:1})]),_:1}),e(o,{title:"Plain",source:`<pf-menu-toggle variant="plain"><ellipsis-vertical-icon /></pf-menu-toggle>
{{ ' ' }}
<pf-menu-toggle variant="plain" expanded><ellipsis-vertical-icon /></pf-menu-toggle>
{{ ' ' }}
<pf-menu-toggle variant="plain" disabled><ellipsis-vertical-icon /></pf-menu-toggle>`},{default:t(()=>[e(n,{variant:"plain"},{default:t(()=>[e(u(r))]),_:1}),a(" "+l(" ")+" "),e(n,{variant:"plain",expanded:""},{default:t(()=>[e(u(r))]),_:1}),a(" "+l(" ")+" "),e(n,{variant:"plain",disabled:""},{default:t(()=>[e(u(r))]),_:1})]),_:1}),e(o,{title:"Plain with text",source:`<pf-menu-toggle variant="plainText">Custom text</pf-menu-toggle>
{{ ' ' }}
...
</pf-menu-toggle>`},{default:t(()=>[e(n,{"split-button":"action"},{default:t(()=>[e(d,null,{default:t(()=>[a("Action")]),_:1})]),_:1}),a(" "+l(" ")+" "),e(n,{"split-button":"action",expanded:""},{default:t(()=>[e(d,null,{default:t(()=>[a("Action")]),_:1})]),_:1}),a(" "+l(" ")+" "),e(n,{"split-button":"action",disabled:""},{default:t(()=>[e(d,{disabled:""},{default:t(()=>[a("Action")]),_:1})]),_:1})]),_:1}),e(o,{title:"Split button (action, primary)",source:`<pf-menu-toggle split-button="action" variant="primary">
  <pf-menu-toggle-action>Action</pf-menu-toggle-action>
</pf-menu-toggle>
{{ ' ' }}
...
<pf-menu-toggle split-button="action" variant="primary" disabled>
  <pf-menu-toggle-action disabled>Action</pf-menu-toggle-action>
</pf-menu-toggle>`},{default:t(()=>[e(n,{"split-button":"action",variant:"primary"},{default:t(()=>[e(d,null,{default:t(()=>[a("Action")]),_:1})]),_:1}),a(" "+l(" ")+" "),e(n,{"split-button":"action",variant:"primary",expanded:""},{default:t(()=>[e(d,null,{default:t(()=>[a("Action")]),_:1})]),_:1}),a(" "+l(" ")+" "),e(n,{"split-button":"action",variant:"primary",disabled:""},{default:t(()=>[e(d,{disabled:""},{default:t(()=>[a("Action")]),_:1})]),_:1})]),_:1}),e(o,{title:"Split button (action, secondary)",source:`<pf-menu-toggle split-button="action" variant="secondary">
  <pf-menu-toggle-action>Action</pf-menu-toggle-action>
</pf-menu-toggle>
{{ ' ' }}
...
<pf-menu-toggle split-button="action" variant="secondary" disabled>
  <pf-menu-toggle-action disabled>Action</pf-menu-toggle-action>
</pf-menu-toggle>`},{default:t(()=>[e(n,{"split-button":"action",variant:"secondary"},{default:t(()=>[e(d,null,{default:t(()=>[a("Action")]),_:1})]),_:1}),a(" "+l(" ")+" "),e(n,{"split-button":"action",variant:"secondary",expanded:""},{default:t(()=>[e(d,null,{default:t(()=>[a("Action")]),_:1})]),_:1}),a(" "+l(" ")+" "),e(n,{"split-button":"action",variant:"secondary",disabled:""},{default:t(()=>[e(d,{disabled:""},{default:t(()=>[a("Action")]),_:1})]),_:1})]),_:1}),e(o,{title:"With icon/image and text",source:`<pf-menu-toggle variant="secondary">
  <template #icon>
    <gear-icon />
  </template>
  Icon
...
<pf-menu-toggle variant="secondary" disabled>
  ...
  Icon
</pf-menu-toggle>`},{default:t(()=>[e(n,{variant:"secondary"},{icon:t(()=>[e(u(c))]),default:t(()=>[a(" Icon ")]),_:1}),a(" "+l(" ")+" "),e(n,{variant:"secondary",disabled:""},{icon:t(()=>[e(u(c))]),default:t(()=>[a(" Icon ")]),_:1})]),_:1}),e(o,{title:"With avatar and text",source:`<pf-menu-toggle>
  <template #icon>
...
</div>`},{default:t(()=>[g("div",I,[e(n,{"full-height":""},{default:t(()=>[a("Full height")]),_:1})])]),_:1}),e(o,{title:"Full width",source:"<pf-menu-toggle full-width>Full width</pf-menu-toggle>"},{default:t(()=>[e(n,{"full-width":""},{default:t(()=>[a("Full width")]),_:1})]),_:1})]),_:1})}}});const F=A(S,[["__scopeId","data-v-33033df3"]]);export{F as default};
