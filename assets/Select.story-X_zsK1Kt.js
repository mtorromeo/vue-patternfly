import{f as A,r as v,g as L,a as o,o as i,c as p,w as a,b as u,d as e,k as O,t as q,i as g,j as h,F as y,e as s}from"./index-lgjncdPo.js";const P=s("b",null,"select list",-1),R=s("div",{class:"markdown pf-v5-c-content"},[s("h2",{class:"pf-v5-c-title"},"Differences from patternfly-react"),s("ul",null,[s("li",null,[u("There is no "),s("code",null,"grouped"),u(" prop since the presence of groups is auto-detected.")]),s("li",null,'A default menu toggle is already included but can be overridden with the "toggle" slot.')]),s("p",null,[u("See "),s("a",{href:"#/"},"common differences from patternfly-react"),u(".")]),s("h2",{class:"pf-v5-c-title"},"Examples")],-1),W=A({__name:"Select.story",setup(U){const S=v(!1),k=v(!1),_=v(),w=v([]),x=v(""),F=L({Status:[{value:"Running",favorite:!1,description:"This is a description."},{value:"Stopped",favorite:!1},{value:"Down",favorite:!1,disabled:!0},{value:"Degraded",favorite:!1},{value:"Needs maintenance",favorite:!1}],"Vendor names":[{value:"Dell",favorite:!1},{value:"Samsung",favorite:!1},{value:"Hewlett-Packard",favorite:!1,description:"This is a description."}]});return(E,r)=>{const m=o("component-info"),D=o("pf-checkbox"),t=o("pf-select-option"),d=o("pf-select"),c=o("story-canvas"),I=o("pf-divider"),b=o("pf-select-group"),C=o("pf-badge"),N=o("pf-search-input"),T=o("pf-menu-input"),V=o("doc-page");return i(),p(V,{name:"Components/Select.story.vue",title:"Select"},{description:a(()=>[u("A "),P,u(" enables users to select one or more items from a list. Use a select list when options are dynamic or variable.")]),apidocs:a(()=>[e(m,{src:"packages/core/src/components/Select/Select.vue"}),e(m,{src:"packages/core/src/components/Menu/MenuGroup.vue",doc:{name:"PfMenuGroup",exportName:"default",displayName:"MenuGroup",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"label",description:"Group label",required:!1,type:{name:"string"}},{name:"titleId",description:"ID for title label",required:!1,type:{name:"string"}},{name:"labelHeadingLevel",description:"Group label heading level. Default is h1.",required:!1,type:{name:"union",elements:[{name:'"h1"'},{name:'"h2"'},{name:'"h3"'},{name:'"h4"'},{name:'"h5"'},{name:'"h6"'}]},defaultValue:{func:!1,value:"'h1'"}}],slots:[{name:"label"},{name:"default"}],sourceFiles:["../../packages/core/src/components/Menu/MenuGroup.vue"]},alias:"SelectGroup"},null,8,["doc"]),e(m,{src:"packages/core/src/components/Menu/MenuList.vue",doc:{name:"PfMenuList",exportName:"default",displayName:"MenuList",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}}],slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Menu/MenuList.vue"]},alias:"SelectList"},null,8,["doc"]),e(m,{src:"packages/core/src/components/Menu/MenuItem.vue",doc:{name:"PfMenuItem",exportName:"default",displayName:"MenuItem",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"name",required:!1,type:{name:"string"}},{name:"value",required:!1,type:{name:"string"}},{name:"to",description:"Target navigation link",required:!1,type:{name:"string"}},{name:"check",tags:{beta:[{description:"Flag indicating the item has a checkbox",title:"beta"}]},required:!1,type:{name:"boolean"}},{name:"checkName",tags:{beta:[{description:"Name of the checkbox",title:"beta"}]},required:!1,type:{name:"string"}},{name:"active",description:"Flag indicating whether the item is active",required:!1,type:{name:"boolean"}},{name:"favorited",description:"Flag indicating if the item is favorited",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"undefined"}},{name:"loadButton",description:"Flag indicating if the item causes a load",required:!1,type:{name:"boolean"}},{name:"loading",description:"Flag indicating a loading state",required:!1,type:{name:"boolean"}},{name:"component",description:"Component used to render the menu item",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'button'"}},{name:"disabled",description:"Render item as disabled option",required:!1,type:{name:"boolean"}},{name:"description",description:"Description of the menu item",required:!1,type:{name:"string"}},{name:"externalLink",description:"Render external link icon",required:!1,type:{name:"boolean"}},{name:"selected",description:"Flag indicating if the option is selected",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"undefined"}},{name:"focused",description:"Flag indicating the item is focused",required:!1,type:{name:"boolean"}},{name:"danger",description:"Flag indicating the item is in danger state",required:!1,type:{name:"boolean"}},{name:"direction",tags:{beta:[{description:"Sub menu direction",title:"beta"}]},required:!1,type:{name:"union",elements:[{name:'"down"'},{name:'"up"'}]}},{name:"onPath",tags:{beta:[{description:"True if item is on current selection path",title:"beta"}]},required:!1,type:{name:"boolean"}}],events:[{name:"update:favorited",type:{names:["boolean"]}},{name:"click",type:{names:["Event"]},description:"Callback for item click"},{name:"show-flyout",type:{names:["Event"]},tags:[{title:"beta",content:"Callback function when mouse leaves trigger"}]}],slots:[{name:"icon"},{name:"default"},{name:"description"},{name:"flyoutMenu"},{name:"actions"}],sourceFiles:["../../packages/core/src/components/Menu/MenuItem.vue"]},alias:"SelectItem"},null,8,["doc"])]),default:a(()=>[R,e(c,{title:"Single",source:`<pf-checkbox v-model="disabled" label="Disabled" />
...
</pf-select>`},{default:a(()=>[e(d,null,{default:a(()=>[e(t,{value:"Active",description:"This is a description"}),e(t,{value:"Cancelled"}),e(t,{value:"Paused"}),S.value?(i(),p(I,{key:0})):O("",!0),e(t,{value:"Warning"}),e(t,{value:"Restarted"})]),_:1})]),_:1}),e(c,{title:"Grouped single",source:`<pf-select>
...
</pf-select>`},{default:a(()=>[e(d,null,{default:a(()=>[e(b,{label:"Status"},{default:a(()=>[e(t,{value:"Running"}),e(t,{value:"Stopped"}),e(t,{value:"Down"}),e(t,{value:"Degraded"}),e(t,{value:"Needs maintenance"})]),_:1}),S.value?(i(),p(I,{key:0})):O("",!0),e(b,{label:"Vendor names"},{default:a(()=>[e(t,{value:"Dell"}),e(t,{value:"Samsung",disabled:""}),e(t,{value:"Hewlett-Packard"})]),_:1})]),_:1})]),_:1}),e(c,{title:"Checkbox input",source:`<pf-select v-model:selected="selectedSingle" placeholder="Filter by status" variant="primary">
...
</pf-select>`},{default:a(()=>[e(d,{selected:_.value,"onUpdate:selected":r[1]||(r[1]=l=>_.value=l),placeholder:"Filter by status",variant:"primary"},{label:a(()=>[u(q(_.value??"Select a value"),1)]),default:a(()=>[e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1},8,["selected"])]),_:1}),e(c,{title:"Checkbox input with counts",source:`<pf-select v-model:selected="selectedMulti" placeholder="Filter by status" variant="secondary">
  <template #label>
    Filter by status
...
</pf-select>`},{default:a(()=>[e(d,{selected:w.value,"onUpdate:selected":r[2]||(r[2]=l=>w.value=l),placeholder:"Filter by status",variant:"secondary"},{label:a(()=>[u(" Filter by status "),e(C,null,{default:a(()=>[u(q(w.value.length),1)]),_:1})]),default:a(()=>[e(t,{check:"",value:"Debug"}),e(t,{check:"",value:"Info"}),e(t,{check:"",value:"Warn"}),e(t,{check:"",value:"Error",disabled:""})]),_:1},8,["selected"])]),_:1}),e(c,{title:"Grouped single with filtering",source:`<pf-select placeholder="Filter by status">
  <pf-menu-input>
...
</pf-select>`},{default:a(()=>[e(d,{placeholder:"Filter by status"},{default:a(()=>[e(T,null,{default:a(()=>[e(N,{modelValue:x.value,"onUpdate:modelValue":r[3]||(r[3]=l=>x.value=l)},null,8,["modelValue"])]),_:1}),e(I),(i(!0),g(y,null,h(F,(l,f)=>(i(),p(b,{key:f,label:f},{default:a(()=>[(i(!0),g(y,null,h(l.filter(n=>n.value.toLowerCase().includes(x.value.toLowerCase())),n=>(i(),p(t,{key:n.value,favorited:n.favorite,"onUpdate:favorited":M=>n.favorite=M,value:n.value,description:n.description,disabled:n.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(c,{title:"Favorites",source:`<pf-select>
  <pf-select-group v-for="(groupOptions, group) of options" :key="group" :label="group">
    <pf-select-option
...
</pf-select>`},{default:a(()=>[e(d,null,{default:a(()=>[(i(!0),g(y,null,h(F,(l,f)=>(i(),p(b,{key:f,label:f},{default:a(()=>[(i(!0),g(y,null,h(l,n=>(i(),p(t,{key:n.value,favorited:n.favorite,"onUpdate:favorited":M=>n.favorite=M,value:n.value,description:n.description,disabled:n.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(c,{title:"Typeahead test",src:"./Select-Typeahead.vue",source:`<template>
