import{C as d}from"./cubes-icon-5b7f880b.js";import{c as h}from"./createIcon-21000036.js";import{M as b}from"./magnifying-glass-icon-45121333.js";import{e as g,a as n,o as v,c as k,w as e,b as t,u as c,g as a}from"./index-20e7d4ce.js";const C={name:"CheckIcon",height:512,width:448,svgPath:"M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z",yOffset:0,xOffset:0},x=h(C),I=x,B=g({__name:"EmptyState.story",setup(N){return(P,w)=>{const u=n("component-title"),p=n("pf-empty-state-header"),i=n("pf-empty-state-body"),o=n("pf-button"),f=n("pf-empty-state-actions"),r=n("pf-empty-state-footer"),l=n("pf-empty-state"),s=n("story-canvas"),y=n("pf-spinner"),m=n("pf-empty-state-icon"),_=n("doc-page");return v(),k(_,{title:"Empty State"},{default:e(()=>[t(u,{name:"pf-empty-state"}),t(s,{title:"Example",source:`<pf-empty-state>
...
</pf-empty-state>`},{default:e(()=>[t(l,null,{default:e(()=>[t(p,{title:"No results found","heading-level":"h4"},{icon:e(()=>[t(c(b))]),_:1}),t(i,null,{default:e(()=>[a(" No results match the filter criteria. Clear all filters and try again. ")]),_:1}),t(r,null,{default:e(()=>[t(f,null,{default:e(()=>[t(o,{variant:"link"},{default:e(()=>[a("Clear all filters")]),_:1})]),_:1})]),_:1})]),_:1})]),_:1}),t(s,{title:"Custom icon color",source:`<pf-empty-state>
...
</pf-empty-state>`},{default:e(()=>[t(l,null,{default:e(()=>[t(p,{title:"Custom icon color","heading-level":"h4"},{icon:e(()=>[t(m,{color:"var(--pf-v5-global--success-color--100)"},{default:e(()=>[t(c(I))]),_:1})]),_:1}),t(i,null,{default:e(()=>[a(" This represents the empty state pattern in PatternFly with a custom icon color. Hopefully it's simple enough to use but flexible enough to meet a variety of needs ")]),_:1})]),_:1})]),_:1})]),_:1})}}});export{B as default};
