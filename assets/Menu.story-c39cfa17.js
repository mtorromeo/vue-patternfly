...
</pf-menu>`},{default:n(()=>[e(u,null,{default:n(()=>[(_(!0),D(B,null,w(z,(A,v)=>(_(),y(r,{key:v,label:v},{default:n(()=>[(_(!0),D(B,null,w(A,s=>(_(),y(i,{key:s.value,favorited:s.favorite,"onUpdate:favorited":T=>s.favorite=T,value:s.value,description:s.description,disabled:s.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(a,{title:"Filtering with text input",source:`<pf-menu>
  <pf-menu-input>
