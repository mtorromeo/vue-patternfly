import{c as r}from"./createIcon-41a437a1.js";import{G as z}from"./gear-icon-dad29f92.js";import{C as c}from"./circle-plus-icon-537a19a2.js";import{C as v}from"./circle-exclamation-icon-1eff22b4.js";import{C as w}from"./circle-info-icon-4e4b3e3c.js";import{B as b}from"./bell-icon-5d8eda5b.js";import{e as y,r as _,a as l,o as k,c as A,w as e,b as n,u as i,g as t,d as s}from"./index-181aa998.js";const S={name:"ArrowDownLongIcon",height:512,width:384,svgPath:"M169.4 502.6c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 402.7 224 32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 370.7L86.6 329.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128z",yOffset:0,xOffset:0},L=r(S),D=L,T={name:"AngleRightIcon",height:512,width:320,svgPath:"M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z",yOffset:0,xOffset:0},V=r(T),O=V,B={name:"AngleDownIcon",height:512,width:448,svgPath:"M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z",yOffset:0,xOffset:0},E=r(B),M=E,R={name:"TriangleExclamationIcon",height:512,width:512,svgPath:"M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480H40c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24V296c0 13.3 10.7 24 24 24s24-10.7 24-24V184c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z",yOffset:0,xOffset:0},$=r(R),G=$,H={name:"CircleCheckIcon",height:512,width:512,svgPath:"M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z",yOffset:0,xOffset:0},N=r(H),g=N,q=s("div",{class:"markdown pf-v5-c-content"},[s("p",null,[t("An "),s("strong",null,"icon"),t(" component is a container that allows for icons of varying dimensions, as well as spinners, to seamlessly replace each other without shifting surrounding content.")])],-1),Q=s("div",{class:"markdown pf-v5-c-content"},[s("p",null,"The following example demonstrates the various status variants of an icon. Keep in mind that these icons are displayed out of a typical context, and that you should not rely on color alone to convey status to users.")],-1),U=s("div",{class:"markdown pf-v5-c-content"},[s("p",null,"Providing both size and iconSize properties allows the icon container to maintain a consistent size, even if the icon changes in size.")],-1),K=s("div",{class:"markdown pf-v5-c-content"},[s("p",null,[t("Passing the "),s("code",null,"isInProgress"),t(" property will swap the icon to a progress icon. By default this progress icon will be a "),s("code",null,"Spinner"),t(" but may be customized or overriden using the "),s("code",null,"progressIcon"),t(" property.")])],-1),j={style:{"margin-bottom":"12px"}},F={style:{"margin-bottom":"12px"}},cn=y({__name:"Icon.story",setup(J){const f=_(!1),m=_(!1);return(W,u)=>{const C=l("component-title"),o=l("pf-icon"),a=l("story-canvas"),p=l("pf-text"),h=l("pf-text-content"),I=l("pf-checkbox"),x=l("pf-spinner"),P=l("doc-page");return k(),A(P,{title:"Icon"},{default:e(()=>[n(C,{name:"pf-icon"}),q,n(a,{title:"Basic",source:`<pf-icon>
...
<pf-icon>
  <GearIcon></GearIcon>
</pf-icon>`},{default:e(()=>[n(o,null,{default:e(()=>[n(i(D))]),_:1}),n(o,null,{default:e(()=>[n(i(O))]),_:1}),n(o,null,{default:e(()=>[n(i(M))]),_:1}),n(o,null,{default:e(()=>[n(i(z))]),_:1})]),_:1}),n(a,{title:"Size",source:`<pf-icon size="sm">
