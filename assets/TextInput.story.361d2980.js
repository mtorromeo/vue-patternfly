import{e as m,r as p,a as u,c as x,w as t,o as v,b as e,d as i}from"./index.85902118.js";const f=i("br",null,null,-1),b=i("br",null,null,-1),_=i("br",null,null,-1),h=i("br",null,null,-1),g=i("br",null,null,-1),q=i("br",null,null,-1),z=m({__name:"TextInput.story",setup(w){const r=p(""),d=p("");return(C,n)=>{const s=u("component-title"),a=u("pf-text-input"),l=u("story-canvas"),c=u("doc-page");return v(),x(c,{title:"Text Input"},{default:t(()=>[e(s,{name:"pf-text-input"}),e(l,{title:"Basic",source:'<pf-text-input v-model="text1" aria-label="text input example" ></pf-text-input>'},{default:t(()=>[e(a,{modelValue:r.value,"onUpdate:modelValue":n[0]||(n[0]=o=>r.value=o),"aria-label":"text input example"},null,8,["modelValue"])]),_:1}),e(l,{title:"Disabled",source:`<pf-text-input
disabled
