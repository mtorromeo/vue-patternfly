...
<pf-alert variant="danger" title="Danger alert title" ></pf-alert>`},{default:e(()=>[t(l,{title:"Default alert title"}),t(l,{variant:"info",title:"Info alert title"}),t(l,{variant:"success",title:"Success alert title"}),t(l,{variant:"warning",title:"Warning alert title"}),t(l,{variant:"danger",title:"Danger alert title"})]),_:1}),t(r,{title:"With action links",source:`<pf-alert title="Alert title" @close="alert('Clicked the close button')">
  ...
  <p>{{ sample_text }}</p>
</pf-alert>`},{default:e(()=>[t(l,{title:"Alert title",onClose:a[2]||(a[2]=i=>o("Clicked the close button"))},{"action-links":e(()=>[t(y,{onClick:a[0]||(a[0]=i=>o("Clicked on View details"))},{default:e(()=>[n("View details")]),_:1}),t(y,{onClick:a[1]||(a[1]=i=>o("Clicked on Ignore"))},{default:e(()=>[n("Ignore")]),_:1})]),default:e(()=>[_("p",null,F(R.value),1)]),_:1})]),_:1}),t(r,{title:"Inline types",source:`<pf-alert variant="default" inline title="Default alert title" ></pf-alert>
