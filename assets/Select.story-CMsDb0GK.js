...
</pf-select>`},{default:n(()=>[e(N,{modelValue:k.value,"onUpdate:modelValue":a[0]||(a[0]=i=>k.value=i),label:"Disabled"},null,8,["modelValue"]),e(c,{disabled:k.value},{default:n(()=>[e(t,{disabled:""},{default:n(()=>[...a[5]||(a[5]=[u(" Please Choose ",-1)])]),_:1}),e(t,{value:"Mr"}),e(t,{value:"Miss"}),e(t,{value:"Mrs"}),e(t,{value:"Ms"}),e(t,{value:"Dr",disabled:""})]),_:1},8,["disabled"])]),_:1}),e(d,{title:"Single with description",source:`<pf-select>
...
</pf-select>`},{default:n(()=>[e(c,null,{default:n(()=>[e(t,{value:"Active",description:"This is a description"}),e(t,{value:"Cancelled"}),e(t,{value:"Paused"}),S.value?(s(),p(_,{key:0})):F("",!0),e(t,{value:"Warning"}),e(t,{value:"Restarted"})]),_:1})]),_:1}),e(d,{title:"Grouped single",source:`<pf-select>
...
</pf-select>`},{default:n(()=>[e(c,null,{default:n(()=>[e(g,{label:"Status"},{default:n(()=>[e(t,{value:"Running"}),e(t,{value:"Stopped"}),e(t,{value:"Down"}),e(t,{value:"Degraded"}),e(t,{value:"Needs maintenance"})]),_:1}),S.value?(s(),p(_,{key:0})):F("",!0),e(g,{label:"Vendor names"},{default:n(()=>[e(t,{value:"Dell"}),e(t,{value:"Samsung",disabled:""}),e(t,{value:"Hewlett-Packard"})]),_:1})]),_:1})]),_:1}),e(d,{title:"Checkbox input",source:`<pf-select v-model:selected="selectedSingle" placeholder="Filter by status" variant="primary">
...
</pf-select>`},{default:n(()=>[e(c,{selected:w.value,"onUpdate:selected":a[1]||(a[1]=i=>w.value=i),placeholder:"Filter by status",variant:"primary"},{label:n(()=>[u(O(w.value??"Select a value"),1)]),default:n(()=>[e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1},8,["selected"])]),_:1}),e(d,{title:"Checkbox input with counts",source:`<pf-select v-model:selected="selectedMulti" placeholder="Filter by status" variant="secondary">
  <template #label>
    Filter by status
...
</pf-select>`},{default:n(()=>[e(c,{selected:x.value,"onUpdate:selected":a[2]||(a[2]=i=>x.value=i),placeholder:"Filter by status",variant:"secondary"},{label:n(()=>[a[6]||(a[6]=u(" Filter by status ",-1)),e(T,null,{default:n(()=>[u(O(x.value.length),1)]),_:1})]),default:n(()=>[e(t,{check:"",value:"Debug"}),e(t,{check:"",value:"Info"}),e(t,{check:"",value:"Warn"}),e(t,{check:"",value:"Error",disabled:""})]),_:1},8,["selected"])]),_:1}),e(d,{title:"Grouped single with filtering",source:`<pf-select placeholder="Filter by status">
  <pf-menu-input>
...
</pf-select>`},{default:n(()=>[e(c,{placeholder:"Filter by status"},{default:n(()=>[e(D,null,{default:n(()=>[e(C,{modelValue:I.value,"onUpdate:modelValue":a[3]||(a[3]=i=>I.value=i)},null,8,["modelValue"])]),_:1}),e(_),(s(!0),b(h,null,y(q,(i,f)=>(s(),p(g,{key:f,label:f},{default:n(()=>[(s(!0),b(h,null,y(i.filter(l=>l.value.toLowerCase().includes(I.value.toLowerCase())),l=>(s(),p(t,{key:l.value,favorited:l.favorite,"onUpdate:favorited":M=>l.favorite=M,value:l.value,description:l.description,disabled:l.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(d,{title:"Favorites",source:`<pf-select>
  <pf-select-group v-for="(groupOptions, group) of options" :key="group" :label="group">
    <pf-select-option
...
<\/script>`})]),_:1})}}});export{U as default};
