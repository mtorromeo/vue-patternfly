...
@clear="filter2 = ''" />`},{default:n(()=>[a(r,{modelValue:o.value,"onUpdate:modelValue":e[2]||(e[2]=t=>o.value=t),placeholder:"Find by name","results-count":[...o.value.matchAll(/[a-z]/g)].length,onClear:e[3]||(e[3]=t=>o.value="")},null,8,["modelValue","results-count"])]),_:1}),a(s,{title:"With expandable button",source:`<pf-search-input
v-model="filter3"
expandable
