...
</pf-menu>`},{default:n(()=>[e(l,null,{default:n(()=>[(b(!0),x(F,null,L(D,(A,h)=>(b(),I(g,{key:h,label:h},{default:n(()=>[(b(!0),x(F,null,L(A,c=>(b(),I(a,{key:c.value,favorited:c.favorite,"onUpdate:favorited":T=>c.favorite=T,name:c.value,value:c.value,description:c.description,disabled:c.disabled},null,8,["favorited","onUpdate:favorited","name","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(u,{title:"Filtering with search input",source:`<pf-menu>
  <pf-menu-input>
