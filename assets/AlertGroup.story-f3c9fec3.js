import{e as b,f as y,l as $,a as r,o as c,c as A,w as e,b as t,g as i,h as _,i as T,F as m}from"./index-7aa190b1.js";const I=4,h=b({__name:"AlertGroup.story",setup(q){const u=y([]),o=()=>new Date().getTime(),l=y([]),w=()=>console.log("Overflow message clicked"),C=$(()=>{const f=l.length-I;return f>0?`View ${f} more alerts`:""});return(f,n)=>{const D=r("component-title"),p=r("pf-alert"),d=r("pf-alert-group"),v=r("story-canvas"),s=r("pf-button"),k=r("pf-input-group"),S=r("doc-page");return c(),A(S,{title:"Alert Group"},{default:e(()=>[t(D,{name:"pf-alert-group"}),t(v,{title:"Static",source:`<pf-alert-group>
