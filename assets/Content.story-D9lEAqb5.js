import{g as d,r as f,a as i,c as r,o as u,w as e,d as l,b as t,e as a,t as v}from"./index-CiyZyzwL.js";const _=d({__name:"Content.story",setup(h){const s=f("Title text");return(y,n)=>{const m=i("component-info"),o=i("pf-content"),p=i("story-canvas"),c=i("doc-page");return u(),r(c,{name:"Components/Content.story.vue",title:"Content"},{description:e(()=>[...n[0]||(n[0]=[a("A ",-1),l("b",null,"content",-1),a(" component contains a block of styled HTML content.",-1)])]),apidocs:e(()=>[t(m,{name:"PfContent",doc:{name:"PfContent",exportName:"PfContent",displayName:"Content",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"component",description:"The content component. If none provided, it will be a 'div' and styling will be applied to all its child components.",required:!1,type:{name:"union",elements:[{name:'"div"'},{name:'"h1"'},{name:'"h2"'},{name:'"h3"'},{name:'"h4"'},{name:'"h5"'},{name:'"h6"'},{name:'"p"'},{name:'"a"'},{name:'"small"'},{name:'"blockquote"'},{name:'"pre"'},{name:'"hr"'},{name:'"ul"'},{name:'"ol"'},{name:'"dl"'},{name:'"li"'},{name:'"dt"'},{name:'"dd"'}]},defaultValue:{func:!1,value:"'div'"}},{name:"plainList",description:"Modifies the list (ul, ol and dl components) to have plain styling.",required:!1,type:{name:"boolean"}},{name:"visited",description:"Flag to indicate the link (or all links within the content) has visited styles applied if the browser determines the link has been visited.",required:!1,type:{name:"boolean"}},{name:"editorial",description:"Flag to indicate the content has editorial styling. This styling increases the font size of body text and small text by one tier, increasing body text to large and small text to the previous body text size.",required:!1,type:{name:"boolean"}}],events:[],slots:[{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Content.vue"]}})]),default:e(()=>[n[8]||(n[8]=l("div",{class:"markdown pf-v6-c-content"},[l("h2",{class:"pf-v6-c-title"},"Examples")],-1)),t(p,{title:"Text",source:"<pf-content>{{ sample_title }}</pf-content>"},{default:e(()=>[t(o,null,{default:e(()=>[a(v(s.value),1)]),_:1})]),_:1}),t(p,{title:"Text visited",source:`<pf-content>
