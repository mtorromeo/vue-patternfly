...
</pf-select>`},{default:a(()=>[e(c,{selected:x.value,"onUpdate:selected":n[2]||(n[2]=o=>x.value=o),placeholder:"Filter by status",variant:"secondary"},{label:a(()=>[n[6]||(n[6]=u(" Filter by status ",-1)),e(C,null,{default:a(()=>[u(q(x.value.length),1)]),_:1})]),default:a(()=>[e(t,{check:"",value:"Debug"}),e(t,{check:"",value:"Info"}),e(t,{check:"",value:"Warn"}),e(t,{check:"",value:"Error",disabled:""})]),_:1},8,["selected"])]),_:1}),e(d,{title:"Grouped single with filtering",source:`<pf-select placeholder="Filter by status">
  <pf-menu-input>
...
<\/script>`})]),_:1})}}});export{E as default};
