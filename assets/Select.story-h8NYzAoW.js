...
</pf-select>`},{default:a(()=>[e(d,null,{default:a(()=>[e(t,{value:"Active",description:"This is a description"}),e(t,{value:"Cancelled"}),e(t,{value:"Paused"}),S.value?(o(),p(I,{key:0})):O("",!0),e(t,{value:"Warning"}),e(t,{value:"Restarted"})]),_:1})]),_:1}),e(c,{title:"Grouped single",source:`<pf-select>
...
</pf-select>`},{default:a(()=>[e(d,{placeholder:"Filter by status"},{default:a(()=>[e(T,null,{default:a(()=>[e(N,{modelValue:x.value,"onUpdate:modelValue":r[3]||(r[3]=l=>x.value=l)},null,8,["modelValue"])]),_:1}),e(I),(o(!0),g(y,null,h(F,(l,f)=>(o(),p(b,{key:f,label:f},{default:a(()=>[(o(!0),g(y,null,h(l.filter(n=>n.value.toLowerCase().includes(x.value.toLowerCase())),n=>(o(),p(t,{key:n.value,favorited:n.favorite,"onUpdate:favorited":M=>n.favorite=M,value:n.value,description:n.description,disabled:n.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(c,{title:"Favorites",source:`<pf-select>
  <pf-select-group v-for="(groupOptions, group) of options" :key="group" :label="group">
    <pf-select-option
