import{e as w,r as S,f as C,a as c,o as p,c as f,w as l,b as e,g as s,j as h,h as b,i as k,F as _,d as o}from"./index-49b72467.js";const P=o("div",{class:"markdown pf-c-content"},[o("p",null,[s("A "),o("strong",null,"select list"),s(" enables users to select one or more items from a list. Use a select list when options are dynamic or variable. "),o("a",{href:"https://www.patternfly.org/v4/components/select/design-guidelines"},"View PatternFly design guidelines")]),o("h2",{class:"pf-c-title"},"Differences from patternfly-react"),o("ul",null,[o("li",null,[s("There is no "),o("code",null,"grouped"),s(" prop since the presence of groups is auto-detected. See "),o("a",{href:"#/"},"common differences from patternfly-react"),s(".")])]),o("h2",{class:"pf-c-title"},"Examples")],-1),T=w({__name:"Select.story",setup(F){const d=S(!1),g=C({Status:[{value:"Running",favorite:!1,description:"This is a description."},{value:"Stopped",favorite:!1},{value:"Down",favorite:!1,disabled:!0},{value:"Degraded",favorite:!1},{value:"Needs maintenance",favorite:!1}],"Vendor names":[{value:"Dell",favorite:!1},{value:"Samsung",favorite:!1},{value:"Hewlett-Packard",favorite:!1,description:"This is a description."}]});return(V,N)=>{const m=c("component-title"),t=c("pf-select-option"),n=c("pf-select"),a=c("story-canvas"),r=c("pf-divider"),u=c("pf-select-group"),M=c("pf-text-input"),y=c("doc-page");return p(),f(y,{title:"Select"},{default:l(()=>[e(m,{name:"pf-select"}),P,e(a,{title:"Single",source:`<pf-select>
