...
</pf-empty-state>`},{default:t(()=>[e(r,null,{default:t(()=>[e(p,{title:"Custom icon color","heading-level":"h4"},{icon:t(()=>[e(d,{color:"var(--pf-v5-global--success-color--100)"},{default:t(()=>[e(f(g))]),_:1})]),_:1}),e(m,null,{default:t(()=>a[11]||(a[11]=[n(" This represents the empty state pattern in PatternFly with a custom icon color. Hopefully it's simple enough to use but flexible enough to meet a variety of needs ")])),_:1})]),_:1})]),_:1})]),_:1})}}});export{A as default};
