import{B as H}from"./bell-icon-74a3bb74.js";import{e as O,r as B,a,o as W,c as D,w as e,b as t,g as n,u as M,d as o}from"./index-1db6e39c.js";import"./createIcon-14b2532e.js";const T=o("div",{class:"markdown pf-c-content"},[o("p",null,[n("The "),o("strong",null,"page"),n(" component is used to define the basic layout of a page with either vertical or horizontal navigation. See full "),o("a",{href:"https://www.patternfly.org/v4/components/page/design-guidelines"},"Design guidelines"),n(" on the official patternfly documentation.")]),o("h2",{class:"pf-c-title"},"Differences from patternfly-react"),o("ul",null,[o("li",null,[o("code",null,"pf-page-breadcrumb"),n(", "),o("code",null,"pf-page-navigation"),n(" and "),o("code",null,"pf-page-section"),n(" can be limited in width by setting their "),o("code",null,"max-width"),n(" prop.")])])],-1),N=o("code",null,"--pf-c-page--section--m-limit-width--MaxWidth",-1),V=o("br",null,null,-1),q=o("br",null,null,-1),F=O({__name:"Page.story",setup(P){const d=B(!1);return(z,b)=>{const w=a("component-title"),f=a("pf-brand"),s=a("pf-page-header-tools-item"),c=a("pf-page-header-tools-group"),g=a("pf-page-header-tools"),u=a("pf-page-header"),p=a("pf-nav-item"),i=a("pf-nav-group"),m=a("pf-nav"),_=a("pf-page-sidebar"),r=a("pf-breadcrumb-item"),y=a("pf-breadcrumb"),k=a("pf-page-breadcrumb"),l=a("pf-page-section"),h=a("pf-page"),v=a("story-canvas"),x=a("pf-card-body"),S=a("pf-card"),A=a("pf-button"),C=a("doc-page");return W(),D(C,{title:"Page"},{default:e(()=>[t(w,{name:"pf-page"}),T,t(v,{title:"Example",source:`<pf-page managed-sidebar>
  <template #skeleton>
