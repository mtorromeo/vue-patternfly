import{C as d}from"./circle-info-icon-Dl_z34sL.js";import{C as x}from"./circle-exclamation-icon-DoNXohQB.js";import{C as c,T as p}from"./triangle-exclamation-icon-CrcKFdwd.js";import{g,a as s,c as y,o as w,w as r,b as n,d as l,e as t,u}from"./index-CiyZyzwL.js";const T=g({__name:"Banner.story",setup(v){return(C,e)=>{const m=s("component-info"),a=s("pf-banner"),i=s("story-canvas"),o=s("pf-flex-item"),f=s("pf-flex"),b=s("doc-page");return w(),y(b,{name:"Components/Banner.story.vue",title:"Banner"},{description:r(()=>[...e[0]||(e[0]=[t("A ",-1),l("b",null,"banner",-1),t(" is a 1-line, full color, full width container that can be used to communicate short snippets of information to users. Banners are un-intrusive and non-dismissible.",-1)])]),apidocs:r(()=>[n(m,{name:"PfBanner",doc:{name:"PfBanner",exportName:"PfBanner",displayName:"Banner",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"sticky",description:"If set to true, the banner sticks to the top of its container",required:!1,type:{name:"boolean"}},{name:"screenReaderText",description:`Text announced by screen readers to indicate the type of banner. This prop should only
be passed in when the banner conveys status/severity.`,required:!1,type:{name:"string"}},{name:"color",description:"Color options for the banner, will be overwritten by any applied using the status prop.",required:!1,type:{name:"union",elements:[{name:'"red"'},{name:'"orangered"'},{name:'"orange"'},{name:'"yellow"'},{name:'"green"'},{name:'"teal"'},{name:'"blue"'},{name:'"purple"'}]}},{name:"status",description:"Status style options for the banner, will overwrite any color applied using the color prop.",required:!1,type:{name:"union",elements:[{name:'"success"'},{name:'"warning"'},{name:'"danger"'},{name:'"info"'},{name:'"custom"'}]}}],events:[],slots:[{name:"screen-reader-text"},{name:"default"}],sourceFiles:["runner/work/vue-patternfly/vue-patternfly/packages/core/src/components/Banner.vue"]}})]),default:r(()=>[n(i,{title:"Basic",source:`<pf-banner>Default banner</pf-banner>
<br>
