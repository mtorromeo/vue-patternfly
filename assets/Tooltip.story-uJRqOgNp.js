...
By setting this prop to 'flip' it attempts to flip the tooltip to the opposite side if there is no space.`,required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"visible",description:"value for visibility when trigger is 'manual'",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"undefined"}}],events:[{name:"update:visible",type:{names:["boolean"]}}],slots:[{name:"default"},{name:"content"}],sourceFiles:["../../packages/core/src/components/Tooltip/Tooltip.vue"]}},null,8,["doc"]),e(x,{src:"packages/core/src/components/Tooltip/TooltipArrow.vue",doc:{name:"PfTooltipArrow",exportName:"default",displayName:"TooltipArrow",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}}],slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Tooltip/TooltipArrow.vue"]}},null,8,["doc"]),e(x,{src:"packages/core/src/components/Tooltip/TooltipContent.vue",doc:{name:"PfTooltipContent",exportName:"default",displayName:"TooltipContent",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"leftAligned",required:!1,type:{name:"boolean"}}],slots:[{name:"default"}],sourceFiles:["../../packages/core/src/components/Tooltip/TooltipContent.vue"]}},null,8,["doc"])]),default:t(()=>[P,e(k,{title:"Basic",source:`<div style="margin: 6rem">
  <pf-tooltip>
...
</div>`},{default:t(()=>[d("div",B,[e(T,null,{content:t(()=>[a("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id feugiat augue, nec fringilla turpis.")]),default:t(()=>[e(q(A),null,{default:t(()=>[a("I have a tooltip!")]),_:1})]),_:1})])]),_:1}),e(k,{title:"Options",source:`<pf-form horizontal>
...
</div>`},{default:t(()=>[e(I,{horizontal:""},{default:t(()=>[e(s,{label:"Trigger"},{default:t(()=>[e(f,{label:"mouseenter","model-value":u.includes("mouseenter"),"onUpdate:modelValue":o[0]||(o[0]=l=>V("mouseenter",l))},null,8,["model-value"]),e(f,{label:"focus","model-value":u.includes("focus"),"onUpdate:modelValue":o[1]||(o[1]=l=>V("focus",l))},null,8,["model-value"]),e(f,{label:"click","model-value":u.includes("click"),"onUpdate:modelValue":o[2]||(o[2]=l=>V("click",l))},null,8,["model-value"])]),_:1}),e(s,{label:"Content"},{default:t(()=>[e(f,{modelValue:c.value,"onUpdate:modelValue":o[3]||(o[3]=l=>c.value=l),label:"Left aligned"},null,8,["modelValue"])]),_:1}),e(s,{label:"Position"},{default:t(()=>[e(f,{modelValue:g.value,"onUpdate:modelValue":o[4]||(o[4]=l=>g.value=l),label:"Flip (used only with position != 'auto')"},null,8,["modelValue"]),e(D,{modelValue:v.value,"onUpdate:modelValue":o[5]||(o[5]=l=>v.value=l)},{default:t(()=>[e(n,{value:"auto"},{default:t(()=>[a("auto")]),_:1}),e(n,{value:"top"},{default:t(()=>[a("top")]),_:1}),e(n,{value:"bottom"},{default:t(()=>[a("bottom")]),_:1}),e(n,{value:"left"},{default:t(()=>[a("left")]),_:1}),e(n,{value:"right"},{default:t(()=>[a("right")]),_:1}),e(n,{value:"top-start"},{default:t(()=>[a("top-start")]),_:1}),e(n,{value:"top-end"},{default:t(()=>[a("top-end")]),_:1}),e(n,{value:"bottom-start"},{default:t(()=>[a("bottom-start")]),_:1}),e(n,{value:"bottom-end"},{default:t(()=>[a("bottom-end")]),_:1}),e(n,{value:"left-start"},{default:t(()=>[a("left-start")]),_:1}),e(n,{value:"left-end"},{default:t(()=>[a("left-end")]),_:1}),e(n,{value:"right-start"},{default:t(()=>[a("right-start")]),_:1}),e(n,{value:"right-end"},{default:t(()=>[a("right-end")]),_:1})]),_:1},8,["modelValue"])]),_:1}),e(s,{label:"Animation duration"},{default:t(()=>[e(m,{modelValue:b.value,"onUpdate:modelValue":o[6]||(o[6]=l=>b.value=l),type:"number"},null,8,["modelValue"])]),_:1}),e(s,{label:"Entry delay"},{default:t(()=>[e(m,{modelValue:h.value,"onUpdate:modelValue":o[7]||(o[7]=l=>h.value=l),type:"number"},null,8,["modelValue"])]),_:1}),e(s,{label:"Exit delay"},{default:t(()=>[e(m,{modelValue:y.value,"onUpdate:modelValue":o[8]||(o[8]=l=>y.value=l),type:"number"},null,8,["modelValue"])]),_:1}),e(s,{label:"Distance"},{default:t(()=>[e(m,{modelValue:_.value,"onUpdate:modelValue":o[9]||(o[9]=l=>_.value=l),type:"number"},null,8,["modelValue"])]),_:1})]),_:1}),d("div",R,[e(N,{style:{height:"200%",width:"200%"}},{default:t(()=>[e(T,{trigger:u.join(" "),"left-aligned":c.value,position:v.value,flip:g.value,"animation-duration":b.value,"entry-delay":h.value,"exit-delay":y.value,distance:_.value},{content:t(()=>[a("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id feugiat augue, nec fringilla turpis.")]),default:t(()=>[e(q(A),{ref_key:"buttonRef",ref:w},{default:t(()=>[a("I have a tooltip!")]),_:1},512)]),_:1},8,["trigger","left-aligned","position","flip","animation-duration","entry-delay","exit-delay","distance"])]),_:1})])]),_:1})]),_:1},8,["name"])}}});export{j as default};
