...
</pf-select>`},{default:a(()=>[e(c,null,{default:a(()=>[e(t,{value:"Active",description:"This is a description"}),e(t,{value:"Cancelled"}),e(t,{value:"Paused"}),S.value?(i(),p(_,{key:0})):O("",!0),e(t,{value:"Warning"}),e(t,{value:"Restarted"})]),_:1})]),_:1}),e(d,{title:"Grouped single",source:`<pf-select>
...
</pf-select>`},{default:a(()=>[e(c,{selected:x.value,"onUpdate:selected":n[2]||(n[2]=o=>x.value=o),placeholder:"Filter by status",variant:"secondary"},{label:a(()=>[n[6]||(n[6]=u(" Filter by status ")),e(N,null,{default:a(()=>[u(q(x.value.length),1)]),_:1})]),default:a(()=>[e(t,{check:"",value:"Debug"}),e(t,{check:"",value:"Info"}),e(t,{check:"",value:"Warn"}),e(t,{check:"",value:"Error",disabled:""})]),_:1},8,["selected"])]),_:1}),e(d,{title:"Grouped single with filtering",source:`<pf-select placeholder="Filter by status">
  <pf-menu-input>
...
</pf-select>`},{default:a(()=>[e(c,{placeholder:"Filter by status"},{default:a(()=>[e(T,null,{default:a(()=>[e(C,{modelValue:I.value,"onUpdate:modelValue":n[3]||(n[3]=o=>I.value=o)},null,8,["modelValue"])]),_:1}),e(_),(i(!0),g(y,null,h(F,(o,f)=>(i(),p(b,{key:f,label:f},{default:a(()=>[(i(!0),g(y,null,h(o.filter(l=>l.value.toLowerCase().includes(I.value.toLowerCase())),l=>(i(),p(t,{key:l.value,favorited:l.favorite,"onUpdate:favorited":M=>l.favorite=M,value:l.value,description:l.description,disabled:l.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(d,{title:"Favorites",source:`<pf-select>
  <pf-select-group v-for="(groupOptions, group) of options" :key="group" :label="group">
    <pf-select-option
