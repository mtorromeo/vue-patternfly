...
</pf-empty-state>`},{default:e(()=>[t(l,null,{default:e(()=>[t(p,{title:"Custom icon color","heading-level":"h4"},{icon:e(()=>[t(u,{color:"var(--pf-v5-global--success-color--100)"},{default:e(()=>[t(r(x))]),_:1})]),_:1}),t(i,null,{default:e(()=>[a(" This represents the empty state pattern in PatternFly with a custom icon color. Hopefully it's simple enough to use but flexible enough to meet a variety of needs ")]),_:1})]),_:1})]),_:1})]),_:1},8,["name"])}}});export{H as default};
