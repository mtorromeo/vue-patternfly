...
</pf-select>`},{default:a(()=>[e(D,{modelValue:k.value,"onUpdate:modelValue":n[0]||(n[0]=o=>k.value=o),label:"Disabled"},null,8,["modelValue"]),e(c,{disabled:k.value},{default:a(()=>[e(t,{disabled:""},{default:a(()=>n[5]||(n[5]=[r(" Please Choose ")])),_:1}),e(t,{value:"Mr"}),e(t,{value:"Miss"}),e(t,{value:"Mrs"}),e(t,{value:"Ms"}),e(t,{value:"Dr",disabled:""})]),_:1},8,["disabled"])]),_:1}),e(d,{title:"Single with description",source:`<pf-select>
...
</pf-select>`},{default:a(()=>[e(c,{selected:w.value,"onUpdate:selected":n[1]||(n[1]=o=>w.value=o),placeholder:"Filter by status",variant:"primary"},{label:a(()=>[r(q(w.value??"Select a value"),1)]),default:a(()=>[e(t,{check:"",value:"Mr"}),e(t,{check:"",value:"Miss"}),e(t,{check:"",value:"Mrs"}),e(t,{check:"",value:"Ms"}),e(t,{check:"",value:"Dr",disabled:""})]),_:1},8,["selected"])]),_:1}),e(d,{title:"Checkbox input with counts",source:`<pf-select v-model:selected="selectedMulti" placeholder="Filter by status" variant="secondary">
  <template #label>
    Filter by status
...
</pf-select>`},{default:a(()=>[e(c,{selected:x.value,"onUpdate:selected":n[2]||(n[2]=o=>x.value=o),placeholder:"Filter by status",variant:"secondary"},{label:a(()=>[n[6]||(n[6]=r(" Filter by status ")),e(N,null,{default:a(()=>[r(q(x.value.length),1)]),_:1})]),default:a(()=>[e(t,{check:"",value:"Debug"}),e(t,{check:"",value:"Info"}),e(t,{check:"",value:"Warn"}),e(t,{check:"",value:"Error",disabled:""})]),_:1},8,["selected"])]),_:1}),e(d,{title:"Grouped single with filtering",source:`<pf-select placeholder="Filter by status">
  <pf-menu-input>
...
</pf-select>`},{default:a(()=>[e(c,{placeholder:"Filter by status"},{default:a(()=>[e(T,null,{default:a(()=>[e(C,{modelValue:I.value,"onUpdate:modelValue":n[3]||(n[3]=o=>I.value=o)},null,8,["modelValue"])]),_:1}),e(_),(s(!0),g(h,null,y(F,(o,f)=>(s(),p(b,{key:f,label:f},{default:a(()=>[(s(!0),g(h,null,y(o.filter(l=>l.value.toLowerCase().includes(I.value.toLowerCase())),l=>(s(),p(t,{key:l.value,favorited:l.favorite,"onUpdate:favorited":M=>l.favorite=M,value:l.value,description:l.description,disabled:l.disabled},null,8,["favorited","onUpdate:favorited","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(d,{title:"Favorites",source:`<pf-select>
  <pf-select-group v-for="(groupOptions, group) of options" :key="group" :label="group">
    <pf-select-option
