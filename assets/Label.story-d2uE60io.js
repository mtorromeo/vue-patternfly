import{C as i}from"./circle-info-icon-BUMv0Em1.js";import{g as c,m as v,a as u,c as g,o as C,w as e,b as o,d as f,e as n,u as a}from"./index-DE0gx5YD.js";const x=c({__name:"Label.story",setup(w){const m=v();function r(d){var p;const l=(p=d.target)==null?void 0:p.closest(".pf-v5-c-label");l instanceof HTMLElement&&m.add({title:`Clicked close button on "${l.innerText}"`,variant:"info"})}return(d,l)=>{const p=u("component-info"),t=u("pf-label"),b=u("story-canvas"),s=u("doc-page");return C(),g(s,{name:"Components/Label.story.vue",title:"Label"},{description:e(()=>l[0]||(l[0]=[n("The "),f("b",null,"label",-1),n(" component allows users to add specific element captions for user clarity and convenience.")])),apidocs:e(()=>[o(p,{src:"packages/core/src/components/Label.vue",doc:{name:"PfLabel",exportName:"default",displayName:"Label",description:"",tags:{},props:[{name:"ouiaSafe",description:"Set the value of data-ouia-safe. Only set to true when the component is in a static state, i.e. no animations are occurring. At all other times, this value must be false.",required:!1,type:{name:"boolean"}},{name:"ouiaId",description:"Value to overwrite the randomly generated data-ouia-component-id.",required:!1,type:{name:"OuiaId"}},{name:"color",description:"The color of the label outline/fill",required:!1,type:{name:"union",elements:[{name:'"blue"'},{name:'"cyan"'},{name:'"green"'},{name:'"orange"'},{name:'"purple"'},{name:'"red"'},{name:'"gold"'},{name:'"grey"'}]},defaultValue:{func:!1,value:"'grey'"}},{name:"variant",required:!1,type:{name:"union",elements:[{name:'"outline"'},{name:'"filled"'}]},defaultValue:{func:!1,value:"'filled'"}},{name:"tooltipPosition",required:!1,type:{name:"Placement"},defaultValue:{func:!1,value:"'top'"}},{name:"to",required:!1,type:{name:"RouteLocationRaw"}},{name:"href",required:!1,type:{name:"string"}},{name:"outline",required:!1,type:{name:"boolean"}},{name:"compact",description:"Flag indicating the label is compact.",required:!1,type:{name:"boolean"}},{name:"overflow",description:"Flag indicating if the label is an overflow label.",required:!1,type:{name:"boolean"}},{name:"textMaxWidth",description:"The max width of the label before it is truncated. Can be any valid CSS unit, such as '100%', '100px', or '16ch'.",required:!1,type:{name:"string"}},{name:"closeBtnAriaLabel",description:"Aria label for close button",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Close'"}},{name:"onClose",description:"Callback for when the label is clicked. This should not be passed in if the href or editable props are also passed in.",required:!1,type:{name:"TSFunctionType"}}],slots:[{name:"icon"},{name:"default"},{name:"actions"}],sourceFiles:["../../packages/core/src/components/Label.vue"]}})]),default:e(()=>[o(b,{title:"Filled",source:`<pf-label>Grey</pf-label>
<pf-label>
  <template #icon>
    <circle-info-icon />
  </template>Grey icon
