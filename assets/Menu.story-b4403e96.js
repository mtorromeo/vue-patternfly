...
</pf-menu>`},{default:n(()=>[e(u,null,{default:n(()=>[(_(!0),D(B,null,w(F,(L,b)=>(_(),y(r,{key:b,label:b},{default:n(()=>[(_(!0),D(B,null,w(L,s=>(_(),y(i,{key:s.value,favorited:s.favorite,"onUpdate:favorited":G=>s.favorite=G,name:s.value,value:s.value,description:s.description,disabled:s.disabled},null,8,["favorited","onUpdate:favorited","name","value","description","disabled"]))),128))]),_:2},1032,["label"]))),128))]),_:1})]),_:1}),e(a,{title:"Filtering with text input",source:`<pf-menu>
  <pf-menu-input>
