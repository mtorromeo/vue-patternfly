<template>
  <doc-page title="Notification drawer">
    ...
    <template #apidocs>
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawer.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerBody.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerGroup.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerGroupList.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerHeader.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerList.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerListItem.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerListItemBody.vue" />
      <component-info src="packages/core/src/components/NotificationDrawer/NotificationDrawerListItemHeader.vue" />
    </template>
