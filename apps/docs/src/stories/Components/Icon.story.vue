<template>
  <doc-page title="Icon">
    ...
    <story-canvas title="Status color">
      <template #intro>
        <pre v-md>
    ...
    <story-canvas title="Sizing an icon within the icon container">
      <template #intro>
        <pre v-md>
    ...
    <story-canvas title="Custom in progress icon">
      <div style="margin-bottom: 12px">
        <pf-checkbox
          v-model="inProgress2"
          label="Toggle in progress state"
