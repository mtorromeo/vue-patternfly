<template>
  <doc-page title="Empty State">
    <component-title name="pf-empty-state" />
    ...
    <story-canvas title="No match found">
      <pf-empty-state>
    ...
    <story-canvas title="Custom icon color">
      <pf-empty-state>
